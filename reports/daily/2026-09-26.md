...
**Updated:** 2026-09-26 11:17 Beijing time (2026-09-26 03:17 UTC) · data: Binance · 10 coins scanned
...
```
POSITION BOOK — 2026-09-26 03:17 UTC / 2026-09-26 11:17 Beijing
...
Checked 2026-09-26 03:17 UTC. History is saved every hour from now on (exchanges keep only ~30 days).

Every building block reads ONE series, the main source (OKX), in backtests and live; Binance is kept as a separate research series and never mixed in (their levels differ).

| Coin | State | Main source | Main history | Funding now | Long/short | Taker buy/sell | Problems |
|---|---|---|---|---|---|---|---|
| BTC | GOOD | okx | 733 h since 2026-08-26 | +0.0017% | 1.29 | 1.20 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=BTCUSDT&period=1h&limit=500 |
| ETH | GOOD | okx | 733 h since 2026-08-26 | +0.0034% | 1.32 | 1.26 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ETHUSDT&period=1h&limit=500 |
| XRP | GOOD | okx | 733 h since 2026-08-26 | +0.0100% | 2.30 | 1.17 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=XRPUSDT&period=1h&limit=500 |
| SOL | GOOD | okx | 733 h since 2026-08-26 | +0.0038% | 1.39 | 1.27 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SOLUSDT&period=1h&limit=500 |
| ZEC | GOOD | okx | 733 h since 2026-08-26 | +0.0062% | 0.55 | 1.20 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ZECUSDT&period=1h&limit=500 |
| SUI | GOOD | okx | 733 h since 2026-08-26 | +0.0015% | 1.80 | 1.31 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SUIUSDT&period=1h&limit=500 |
| ENA | GOOD | okx | 733 h since 2026-08-26 | +0.0050% | 0.92 | 1.02 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ENAUSDT&period=1h&limit=500 |
| BNB | GOOD | okx | 733 h since 2026-08-26 | +0.0100% | 2.47 | 0.66 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=BNBUSDT&period=1h&limit=500 |
| UNI | GOOD | okx | 733 h since 2026-08-26 | +0.0100% | 1.81 | 1.04 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=UNIUSDT&period=1h&limit=500 |
| ADA | GOOD | okx | 720 h since 2026-08-27 | +0.0100% | 1.94 | 0.78 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ADAUSDT&period=1h&limit=500 |
...
|---|---|---|
| VTHO | $123M | 7-day average volume $21M < $50M; spread 0.122% > 0.1%; order book too thin: $23k within 1% (need $250k) |
| LINK | $80M | 7-day average volume $50M < $50M |
| ONDO | $63M | 7-day average volume $49M < $50M; order book too thin: $209k within 1% (need $250k) |
| BABY | $63M | 7-day average volume $25M < $50M; order book too thin: $52k within 1% (need $250k) |
| XPL | $55M | 7-day average volume $25M < $50M; order book too thin: $193k within 1% (need $250k) |
...
|---|---|---|---|---|---|---|
| BTC | mixed (LH/HL) | 84,193.4 / 83,632 | 0.10 | 0.44x | 0.74x | bear_engulf |
| ETH | mixed (LH/HL) | 2,699.5 / 2,677.16 | 0.32 | 0.21x | 0.76x | bull_engulf |
| XRP | up (HH/HL) | 1.63 / 1.5492 | 0.04 | 0.31x | 0.88x | bull_engulf |
| SOL | up (HH/HL) | 122.94 / 120.82 | 0.03 | 0.30x | 1.07x | - |
| ZEC | mixed (LH/HL) | 1,560.64 / 1,524.79 | 0.20 | 0.21x | 0.85x | bear_engulf |
| SUI | up (HH/HL) | 1.2179 / 1.0901 | 0.24 | 0.43x | 1.38x | bear_engulf, bear_div |
| ENA | up (HH/HL) | 0.2642 / 0.2188 | 0.41 | 0.28x | 1.20x | bear_reject |
...
| 1h | displacement_up | 619 | 47% | 36% | 29% | 72% | 43% | 30% | beats chance | 0.26R |
| 1h | displacement_down | 428 | 37% | 24% | 15% | 81% | 39% | 26% | can't tell from chance | 0.17R |
| 1h | bull_engulf | 1684 | 40% | 29% | 22% | 75% | 42% | 29% | can't tell from chance | 0.30R |
| 1h | bear_engulf | 1855 | 40% | 26% | 18% | 79% | 38% | 24% | beats chance | 0.18R |
| 1h | bull_reject | 1398 | 40% | 29% | 22% | 76% | 42% | 29% | can't tell from chance | 0.29R |
| 1h | bear_reject | 1366 | 37% | 25% | 17% | 81% | 39% | 25% | can't tell from chance | 0.17R |
| 1h | smc_sweep_bull | 634 | 40% | 26% | 19% | 78% | 42% | 29% | can't tell from chance | 0.28R |
| 1h | smc_sweep_bear | 701 | 38% | 25% | 16% | 80% | 39% | 25% | can't tell from chance | 0.17R |
| 1h | smc_bos_up | 398 | 43% | 31% | 24% | 78% | 42% | 29% | can't tell from chance | 0.24R |
| 1h | smc_bos_down | 272 | 38% | 28% | 19% | 82% | 38% | 25% | can't tell from chance | 0.20R |
| 1h | smc_choch_up | 117 | 48% | 37% | 32% | 71% | 44% | 31% | can't tell from chance | 0.32R |
| 1h | smc_choch_down | 118 | 45% | 28% | 16% | 76% | 37% | 22% | can't tell from chance | 0.16R |
| 1h | smc_fvg_retrace_bull | 886 | 46% | 33% | 25% | 71% | 42% | 29% | beats chance | 0.28R |
| 1h | smc_fvg_retrace_bear | 831 | 41% | 28% | 19% | 78% | 40% | 26% | can't tell from chance | 0.19R |
| 30m | displacement_up | 652 | 41% | 30% | 25% | 78% | 42% | 30% | can't tell from chance | 0.28R |
| 30m | displacement_down | 428 | 39% | 23% | 14% | 83% | 38% | 22% | can't tell from chance | 0.18R |
| 30m | bull_engulf | 1707 | 42% | 29% | 21% | 75% | 42% | 30% | can't tell from chance | 0.33R |
| 30m | bear_engulf | 1749 | 36% | 22% | 15% | 82% | 36% | 21% | can't tell from chance | 0.20R |
| 30m | bull_reject | 1338 | 45% | 30% | 22% | 74% | 42% | 30% | can't tell from chance | 0.33R |
| 30m | bear_reject | 1431 | 37% | 23% | 15% | 82% | 37% | 21% | can't tell from chance | 0.20R |
| 30m | smc_sweep_bull | 613 | 42% | 29% | 19% | 75% | 41% | 28% | can't tell from chance | 0.33R |
| 30m | smc_sweep_bear | 635 | 41% | 26% | 18% | 82% | 36% | 22% | beats chance | 0.19R |
| 30m | smc_bos_up | 457 | 42% | 33% | 28% | 76% | 42% | 29% | can't tell from chance | 0.31R |
| 30m | smc_bos_down | 237 | 37% | 22% | 13% | 85% | 39% | 23% | can't tell from chance | 0.22R |
| 30m | smc_choch_up | 104 | 37% | 24% | 17% | 83% | 42% | 30% | can't tell from chance | 0.37R |
| 30m | smc_choch_down | 101 | 39% | 22% | 16% | 81% | 38% | 21% | can't tell from chance | 0.18R |
| 30m | smc_fvg_retrace_bull | 971 | 44% | 30% | 23% | 74% | 42% | 29% | can't tell from chance | 0.33R |
| 30m | smc_fvg_retrace_bear | 838 | 38% | 22% | 16% | 81% | 35% | 21% | can't tell from chance | 0.22R |
| 15m | displacement_up | 486 | 34% | 26% | 19% | 82% | 36% | 25% | can't tell from chance | 0.40R |
| 15m | displacement_down | 467 | 34% | 21% | 13% | 85% | 37% | 23% | can't tell from chance | 0.27R |
| 15m | bull_engulf | 1647 | 38% | 27% | 19% | 79% | 35% | 25% | can't tell from chance | 0.46R |
| 15m | bear_engulf | 1616 | 36% | 24% | 15% | 80% | 36% | 22% | can't tell from chance | 0.27R |
| 15m | bull_reject | 1325 | 35% | 23% | 16% | 80% | 36% | 25% | can't tell from chance | 0.47R |
| 15m | bear_reject | 1440 | 35% | 22% | 15% | 82% | 37% | 23% | can't tell from chance | 0.27R |
| 15m | smc_sweep_bull | 598 | 38% | 27% | 21% | 77% | 36% | 25% | can't tell from chance | 0.44R |
| 15m | smc_sweep_bear | 636 | 38% | 25% | 14% | 83% | 37% | 23% | can't tell from chance | 0.26R |
| 15m | smc_bos_up | 374 | 39% | 28% | 21% | 80% | 36% | 25% | can't tell from chance | 0.40R |
| 15m | smc_bos_down | 352 | 34% | 20% | 14% | 86% | 37% | 23% | can't tell from chance | 0.32R |
| 15m | smc_choch_up | 91 | 30% | 22% | 16% | 82% | 36% | 24% | can't tell from chance | 0.44R |
| 15m | smc_choch_down | 89 | 31% | 20% | 12% | 82% | 37% | 22% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 1015 | 34% | 24% | 16% | 81% | 36% | 25% | can't tell from chance | 0.46R |
| 15m | smc_fvg_retrace_bear | 970 | 36% | 25% | 17% | 80% | 36% | 22% | can't tell from chance | 0.29R |
| 5m | displacement_up | 1213 | 31% | 21% | 16% | 85% | 28% | 20% | beats chance | 0.75R |
| 5m | displacement_down | 1137 | 28% | 18% | 12% | 86% | 31% | 20% | worse than chance | 0.49R |
| 5m | bull_engulf | 4111 | 27% | 18% | 13% | 83% | 28% | 19% | can't tell from chance | 0.82R |
| 5m | bear_engulf | 4055 | 31% | 21% | 13% | 83% | 31% | 21% | can't tell from chance | 0.50R |
| 5m | bull_reject | 3406 | 27% | 18% | 13% | 82% | 28% | 19% | can't tell from chance | 0.83R |
| 5m | bear_reject | 3709 | 33% | 22% | 15% | 81% | 32% | 21% | can't tell from chance | 0.48R |
| 5m | smc_sweep_bull | 1195 | 31% | 22% | 15% | 79% | 29% | 20% | can't tell from chance | 0.74R |
| 5m | smc_sweep_bear | 1268 | 35% | 24% | 16% | 81% | 32% | 21% | beats chance | 0.44R |
| 5m | smc_bos_up | 836 | 29% | 21% | 16% | 85% | 28% | 20% | can't tell from chance | 0.77R |
| 5m | smc_bos_down | 869 | 28% | 18% | 11% | 87% | 31% | 20% | can't tell from chance | 0.55R |
| 5m | smc_choch_up | 219 | 38% | 26% | 17% | 85% | 28% | 19% | beats chance | 0.81R |
| 5m | smc_choch_down | 221 | 26% | 15% | 12% | 87% | 30% | 20% | can't tell from chance | 0.50R |
| 5m | smc_fvg_retrace_bull | 3278 | 29% | 20% | 14% | 82% | 28% | 19% | can't tell from chance | 0.82R |
| 5m | smc_fvg_retrace_bear | 2932 | 28% | 19% | 12% | 84% | 31% | 21% | worse than chance | 0.51R |
...
- **1H RANGE (strong)** - for: EMAs not lined up; EMA-fast flat (-0.3 ATR in 10 candles); swing structure mixed; ADX 16 = weak trend / ranging; candle size 0.74x normal, Bollinger width above 22% of the last 100 candles · against: -
...
|---|---|---|---|---|---|---|---|
| **BTC** | up (BOS 26 candles ago) | sell-side (bullish idea) 52 candles ago | bear 84,744.74-84,841.04 | bear 86,133.40-86,975.51 | premium (67%) | swing high 84,193.39 (0.46 ATR) | swing low 83,632.03 (0.95 ATR) |
| **ETH** | up (BOS 4 candles ago) | sell-side (bullish idea) 24 candles ago | bear 2,760.00-2,765.00 (retraced) | bear 2,745.99-2,784.40 | premium (63%) | swing high 2,699.50 (0.51 ATR) | swing low 2,677.16 (0.85 ATR) |
| **XRP** | up (CHOCH 60 candles ago) | buy-side (bearish idea) 5 candles ago | bear 1.6015-1.6117 (retraced) | bull 1.3773-1.3856 | discount (19%) | swing high 1.6300 (3.17 ATR) | swing low 1.5492 (0.76 ATR) |
| **SOL** | down (CHOCH 0 candles ago) | buy-side (bearish idea) 26 candles ago | bull 120.14-120.79 (retraced) | bull 115.86-117.34 | discount (36%) | swing high 122.94 (1.03 ATR) | swing low 120.82 (0.59 ATR) |
| **ZEC** | down (BOS 0 candles ago) | sell-side (bullish idea) 38 candles ago | bear 1,549.43-1,552.00 (retraced) | bull 1,098.88-1,133.82 | discount (39%) | swing high 1,560.64 (0.91 ATR) | swing low 1,524.79 (0.58 ATR) |
| **SUI** | up (BOS 19 candles ago) | buy-side (bearish idea) 28 candles ago | bull 1.0755-1.0969 (retraced) | bull 1.0050-1.0598 | premium (65%) | PDH 1.2179 (1.6 ATR) | swing low 1.0901 (2.97 ATR) |
| **ENA** | up (BOS 12 candles ago) | sell-side (bullish idea) 4 candles ago | bull 0.25770-0.25950 (retraced) | bull 0.16130-0.17050 | above the range (104%) | PDH 0.27010 (0.58 ATR) | swing low 0.21880 (6.81 ATR) |
...
| S5-SWEEP-MSS-FVG-noSMC | 1.0 | 30m | **BACKTESTING** | 13 | 23.1 | -0.353 | 0.44 | 5.1R | -0.51 / -0.10 | -1.17 / -0.11 | 0/5 ✗ | -0.47 | ✗  stop buffer_atr 0.2→0.24: -0.36R | 0 | 0.09R | 0, +0.00 (+0.00 / +0.00) | 537 / 221 of 929 | 0 | only 13 trades; avg -0.35R/trade (needs +0.10R); profit factor 0.44; only 5 unseen-test trades; not profitable in BOTH train and unseen test |
| S5-SWEEP-MSS-FVG-noSMC | 1.0 | 15m | **BACKTESTING** | 14 | 42.9 | -0.365 | 0.42 | 6.5R | -0.43 / +0.05 | -0.31 / -0.39 | 0/5 ✗ | -0.30 | ✗  time_stop_bars 30→24: -0.42R | 0 | 0.16R | 1, +1.21 (+1.21 / +0.00) | 463 / 231 of 820 | 0 | only 14 trades; avg -0.37R/trade (needs +0.10R); profit factor 0.42; only 2 unseen-test trades; not profitable in BOTH train and unseen test |
...
| S8-PDH-PDL-SWEEP-5M | 1.0 | 30m | **BACKTESTING** | 1 | 0.0 | -1.712 | 0.0 | 1.7R | +0.00 / -1.71 | -1.71 / +0.00 | 0/5 ✗ | -2.00 | ✗  stop buffer_atr 0.2→0.16: -1.75R | 0 | 0.86R | 0, +0.00 (+0.00 / +0.00) | 32 / 109 of 151 | 0 | not cost-viable: fees + slippage 0.86R per trade (stop must be ≥ 4x the round-trip cost); only 1 trades; avg -1.71R/trade (needs +0.10R); profit factor 0.00; only 1 unseen-test trades; not profitable in BOTH train and unseen test |
...
| S6-OB-FVG-noSMC | 1.0 | 15m | **FAILED** | 42 | 38.1 | -0.064 | 0.9 | 9.5R | +0.14 / -0.39 | -0.28 / +0.10 | 1/5 ✗ | -0.21 | ✗  time_stop_bars 30→24: -0.04R | 3 | 0.15R | 6, -0.26 (+0.17 / -0.48) | 105 / 35 of 152 | 0 | avg -0.06R/trade (needs +0.10R); profit factor 0.90; not profitable in BOTH train and unseen test |
| donchian_breakout | 1.0 | 30m | **FAILED** | 1294 | 49.1 | -0.065 | 0.88 | 113.8R | -0.08 / -0.04 | -0.04 / -0.09 | 1/5 ✗ | -0.14 | ✗  stop atr 2.0→1.6: -0.14R | 3 | 0.12R | 48, -0.04 (-0.23 / +0.20) | 140 / 60 of 427 | 0 | BIASED - recursive on 1h: long: htf_up (489 of 78216 candles differ, first 2017-10-18 22:00); recursive on 1h: short: htf_down (108 of 78216 candles differ, first 2017-10-25 15:00); avg -0.06R/trade (needs +0.10R); profit factor 0.88; max drawdown 113.8R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7001 | 53.9 | -0.125 | 0.55 | 883.1R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 42, -0.15 (-0.26 / +0.00) | 1040 / 7 of 1398 | 0 | avg -0.13R/trade (needs +0.10R); profit factor 0.55; max drawdown 883.1R; not profitable in BOTH train and unseen test |
| trend_pullback | 1.0 | 1h | **FAILED** | 6248 | 47.1 | -0.146 | 0.75 | 931.0R | -0.15 / -0.14 | -0.18 / -0.10 | 0/5 ✗ | -0.22 | ✗  stop atr 1.5→1.2: -0.18R | 1 | 0.13R | 44, +0.09 (-0.00 / +0.23) | 1215 / 302 of 1882 | 0 | BIASED - recursive on 1h: long: htf_up (489 of 78216 candles differ, first 2017-10-18 22:00); recursive on 1h: short: htf_down (108 of 78216 candles differ, first 2017-10-25 15:00); avg -0.15R/trade (needs +0.10R); profit factor 0.75; max drawdown 931.0R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 30m | **FAILED** | 3465 | 46.3 | -0.189 | 0.69 | 677.0R | -0.18 / -0.22 | -0.21 / -0.17 | 0/5 ✗ | -0.30 | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.18R | 82, +0.15 (+0.26 / +0.00) | 847 / 263 of 1716 | 0 | BIASED - recursive on 1h: long: htf_up (489 of 78216 candles differ, first 2017-10-18 22:00); recursive on 1h: short: htf_down (108 of 78216 candles differ, first 2017-10-25 15:00); avg -0.19R/trade (needs +0.10R); profit factor 0.69; max drawdown 677.0R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 15m | **FAILED** | 3022 | 44.7 | -0.256 | 0.61 | 774.9R | -0.24 / -0.29 | -0.30 / -0.23 | 0/5 ✗ | -0.41 | ✗  stop atr 1.5→1.2: -0.33R | 0 | 0.25R | 165, -0.05 (-0.06 / -0.03) | 1357 / 369 of 2321 | 0 | BIASED - recursive on 1h: long: htf_up (489 of 78216 candles differ, first 2017-10-18 22:00); recursive on 1h: short: htf_down (108 of 78216 candles differ, first 2017-10-25 15:00); not cost-viable: fees + slippage 0.25R per trade (stop must be ≥ 4x the round-trip cost); avg -0.26R/trade (needs +0.10R); profit factor 0.61; max drawdown 774.9R; not profitable in BOTH train and unseen test |
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2181 | 34.6 | -0.336 | 0.21 | 732.7R | -0.32 / -0.36 | -0.43 / -0.26 | 0/5 ✗ | -0.51 | ✗  hi 90→108: -0.43R | 0 | 0.28R | 68, -0.29 (-0.28 / -0.31) | 1192 / 31 of 1367 | 0 | not cost-viable: fees + slippage 0.28R per trade (stop must be ≥ 4x the round-trip cost); avg -0.34R/trade (needs +0.10R); profit factor 0.21; max drawdown 732.7R; not profitable in BOTH train and unseen test |
...
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 621 | 25.0 | -0.458 | 0.53 | 292.8R | -0.47 / -0.43 | -0.55 / -0.38 | 0/5 ✗ | -0.63 | ✗  n 20→24: -0.49R | 1 | 0.35R | 17, +0.15 (+0.64 / -0.41) | 439 / 1065 of 1687 | 0 | not cost-viable: fees + slippage 0.35R per trade (stop must be ≥ 4x the round-trip cost); avg -0.46R/trade (needs +0.10R); profit factor 0.53; max drawdown 292.8R; not profitable in BOTH train and unseen test |
...
| S8-PDH-PDL-SWEEP | 1.0 | 30m | **FAILED** | 113 | 21.2 | -0.500 | 0.49 | 62.1R | -0.39 / -0.70 | -0.56 / -0.45 | 1/5 ✗ | -0.64 | ✗  stop max_width_atr 3.0→2.4: -0.50R | 0 | 0.25R | 3, -0.07 (-1.25 / +2.29) | 32 / 109 of 151 | 0 | avg -0.50R/trade (needs +0.10R); profit factor 0.49; max drawdown 62.1R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 424 | 26.4 | -1.147 | 0.16 | 491.1R | -1.22 / -1.06 | -1.05 / -1.74 | 0/5 ✗ | -1.81 | ✗  stop atr 1.0→0.8: -1.49R | 0 | 1.05R | 114, -1.17 (-1.40 / -0.92) | 183 / 620 of 922 | 0 | not cost-viable: fees + slippage 1.05R per trade (stop must be ≥ 4x the round-trip cost); avg -1.15R/trade (needs +0.10R); profit factor 0.16; max drawdown 491.1R; not profitable in BOTH train and unseen test |
