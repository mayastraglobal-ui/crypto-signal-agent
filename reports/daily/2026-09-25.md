...
**Updated:** 2026-09-26 04:17 Beijing time (2026-09-25 20:17 UTC) · data: Binance · 10 coins scanned

> Signals only - not financial advice. Paper-trade first. Never risk money you cannot afford to lose.

**Storage:** repository 2.7 MB (GitHub) · large files of this run 1.9 MB, published to branch `live-reports` (replaced every run, no history)

```
POSITION BOOK — 2026-09-25 20:17 UTC / 2026-09-26 04:17 Beijing
...
Checked 2026-09-25 20:16 UTC. History is saved every hour from now on (exchanges keep only ~30 days).

Every building block reads ONE series, the main source (OKX), in backtests and live; Binance is kept as a separate research series and never mixed in (their levels differ).

| Coin | State | Main source | Main history | Funding now | Long/short | Taker buy/sell | Problems |
|---|---|---|---|---|---|---|---|
| BTC | GOOD | okx | 726 h since 2026-08-26 | +0.0034% | 1.31 | 0.86 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=BTCUSDT&period=1h&limit=500 |
| ETH | GOOD | okx | 726 h since 2026-08-26 | +0.0000% | 1.32 | 1.11 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ETHUSDT&period=1h&limit=500 |
| XRP | GOOD | okx | 726 h since 2026-08-26 | +0.0063% | 2.16 | 0.95 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=XRPUSDT&period=1h&limit=500 |
| SOL | GOOD | okx | 726 h since 2026-08-26 | +0.0100% | 1.45 | 0.77 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SOLUSDT&period=1h&limit=500 |
| ZEC | GOOD | okx | 726 h since 2026-08-26 | +0.0011% | 0.50 | 0.92 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ZECUSDT&period=1h&limit=500 |
| SUI | GOOD | okx | 726 h since 2026-08-26 | +0.0100% | 1.78 | 1.00 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SUIUSDT&period=1h&limit=500 |
| ENA | GOOD | okx | 726 h since 2026-08-26 | +0.0050% | 0.86 | 0.93 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ENAUSDT&period=1h&limit=500 |
| BNB | GOOD | okx | 726 h since 2026-08-26 | +0.0100% | 2.47 | - | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=BNBUSDT&period=1h&limit=500 |
| UNI | GOOD | okx | 726 h since 2026-08-26 | +0.0100% | 1.75 | 0.98 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=UNIUSDT&period=1h&limit=500 |
| LTC | GOOD | okx | 726 h since 2026-08-26 | +0.0100% | 2.41 | 1.20 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=LTCUSDT&period=1h&limit=500 |
...
|---|---|---|
| VTHO | $124M | 7-day average volume $4M < $50M; spread 0.127% > 0.1%; order book too thin: $71k within 1% (need $250k) |
| SAGA | $89M | 7-day average volume $21M < $50M; suspended for the rest of the UTC day (moved more than ±25% earlier today); order book too thin: $29k within 1% (need $250k) |
| LINK | $82M | 7-day average volume $44M < $50M |
| ONDO | $77M | 7-day average volume $43M < $50M; suspended for the rest of the UTC day (moved more than ±25% earlier today) |
| XPL | $66M | 7-day average volume $18M < $50M; suspended for the rest of the UTC day (moved more than ±25% earlier today); order book too thin: $215k within 1% (need $250k) |
| BABY | $63M | 7-day average volume $16M < $50M; order book too thin: $52k within 1% (need $250k) |
...
|---|---|---|---|---|---|---|
| BTC | mixed (HH/LL) | 85,255 / 83,183 | 0.60 | 0.40x | 0.92x | - |
| ETH | up (HH/HL) | 2,743 / 2,668.84 | 0.48 | 0.39x | 0.95x | - |
| XRP | up (HH/HL) | 1.63 / 1.5444 | 0.69 | 0.38x | 1.04x | - |
| SOL | up (HH/HL) | 122.33 / 118.27 | 0.62 | 0.54x | 1.24x | - |
| ZEC | up (HH/HL) | 1,625 / 1,535.17 | 0.13 | 0.90x | 1.03x | bull_engulf |
| SUI | up (HH/HL) | 1.1615 / 1.0901 | 0.68 | 0.82x | 1.34x | - |
| ENA | up (HH/HL) | 0.2642 / 0.2188 | 0.82 | 0.99x | 1.29x | bull_engulf, retest_up |
...
| 1h | displacement_up | 612 | 47% | 34% | 26% | 74% | 42% | 30% | beats chance | 0.27R |
| 1h | displacement_down | 437 | 37% | 23% | 14% | 81% | 38% | 24% | can't tell from chance | 0.18R |
| 1h | bull_engulf | 1719 | 40% | 29% | 22% | 75% | 42% | 29% | worse than chance | 0.32R |
...
| 1h | bear_reject | 1341 | 36% | 24% | 17% | 82% | 38% | 25% | can't tell from chance | 0.18R |
| 1h | smc_sweep_bull | 648 | 40% | 26% | 19% | 78% | 42% | 29% | can't tell from chance | 0.31R |
| 1h | smc_sweep_bear | 708 | 38% | 24% | 16% | 81% | 38% | 24% | can't tell from chance | 0.19R |
| 1h | smc_bos_up | 409 | 43% | 31% | 23% | 78% | 43% | 30% | can't tell from chance | 0.27R |
...
| 1h | smc_choch_down | 114 | 45% | 29% | 16% | 74% | 35% | 22% | can't tell from chance | 0.17R |
| 1h | smc_fvg_retrace_bull | 880 | 45% | 33% | 25% | 71% | 43% | 30% | can't tell from chance | 0.30R |
| 1h | smc_fvg_retrace_bear | 807 | 41% | 28% | 19% | 78% | 39% | 25% | can't tell from chance | 0.20R |
| 30m | displacement_up | 645 | 42% | 31% | 26% | 77% | 41% | 29% | can't tell from chance | 0.30R |
| 30m | displacement_down | 419 | 39% | 24% | 14% | 83% | 36% | 21% | can't tell from chance | 0.20R |
...
| 30m | bull_reject | 1343 | 44% | 29% | 22% | 74% | 41% | 29% | beats chance | 0.35R |
| 30m | bear_reject | 1409 | 37% | 22% | 15% | 82% | 36% | 21% | can't tell from chance | 0.21R |
| 30m | smc_sweep_bull | 621 | 40% | 27% | 17% | 76% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | smc_sweep_bear | 632 | 41% | 26% | 16% | 83% | 37% | 22% | beats chance | 0.21R |
| 30m | smc_bos_up | 465 | 40% | 32% | 27% | 77% | 42% | 30% | can't tell from chance | 0.32R |
| 30m | smc_bos_down | 233 | 35% | 23% | 13% | 85% | 34% | 20% | can't tell from chance | 0.24R |
| 30m | smc_choch_up | 103 | 36% | 22% | 17% | 83% | 45% | 33% | can't tell from chance | 0.39R |
| 30m | smc_choch_down | 101 | 36% | 21% | 16% | 82% | 36% | 22% | can't tell from chance | 0.19R |
| 30m | smc_fvg_retrace_bull | 982 | 42% | 29% | 22% | 75% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | smc_fvg_retrace_bear | 826 | 38% | 22% | 16% | 81% | 36% | 22% | can't tell from chance | 0.24R |
| 15m | displacement_up | 500 | 36% | 27% | 20% | 82% | 36% | 25% | can't tell from chance | 0.42R |
| 15m | displacement_down | 457 | 35% | 22% | 13% | 84% | 36% | 22% | can't tell from chance | 0.30R |
| 15m | bull_engulf | 1661 | 38% | 27% | 19% | 78% | 35% | 25% | can't tell from chance | 0.50R |
| 15m | bear_engulf | 1612 | 36% | 24% | 15% | 80% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | bull_reject | 1322 | 35% | 23% | 16% | 81% | 36% | 25% | can't tell from chance | 0.52R |
| 15m | bear_reject | 1447 | 35% | 22% | 15% | 82% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | smc_sweep_bull | 597 | 37% | 25% | 21% | 78% | 37% | 26% | can't tell from chance | 0.46R |
| 15m | smc_sweep_bear | 641 | 38% | 25% | 14% | 83% | 37% | 23% | can't tell from chance | 0.29R |
| 15m | smc_bos_up | 363 | 40% | 29% | 23% | 80% | 37% | 26% | can't tell from chance | 0.42R |
| 15m | smc_bos_down | 344 | 34% | 20% | 14% | 85% | 36% | 22% | can't tell from chance | 0.33R |
| 15m | smc_choch_up | 89 | 33% | 24% | 18% | 80% | 36% | 26% | can't tell from chance | 0.45R |
| 15m | smc_choch_down | 86 | 33% | 21% | 14% | 81% | 35% | 22% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 1026 | 34% | 24% | 16% | 81% | 36% | 25% | can't tell from chance | 0.49R |
| 15m | smc_fvg_retrace_bear | 969 | 37% | 26% | 17% | 80% | 36% | 22% | can't tell from chance | 0.31R |
| 5m | displacement_up | 1216 | 32% | 21% | 16% | 84% | 28% | 20% | beats chance | 0.79R |
| 5m | displacement_down | 1136 | 28% | 18% | 12% | 86% | 31% | 20% | worse than chance | 0.52R |
| 5m | bull_engulf | 4147 | 27% | 18% | 13% | 83% | 28% | 19% | can't tell from chance | 0.87R |
| 5m | bear_engulf | 4085 | 32% | 21% | 14% | 83% | 31% | 21% | can't tell from chance | 0.53R |
| 5m | bull_reject | 3452 | 27% | 18% | 13% | 81% | 28% | 19% | can't tell from chance | 0.89R |
| 5m | bear_reject | 3700 | 33% | 22% | 15% | 82% | 32% | 21% | can't tell from chance | 0.51R |
| 5m | smc_sweep_bull | 1220 | 31% | 22% | 15% | 79% | 29% | 20% | can't tell from chance | 0.78R |
| 5m | smc_sweep_bear | 1284 | 35% | 25% | 17% | 81% | 32% | 21% | beats chance | 0.44R |
| 5m | smc_bos_up | 821 | 29% | 21% | 17% | 84% | 28% | 19% | can't tell from chance | 0.82R |
| 5m | smc_bos_down | 897 | 28% | 19% | 11% | 87% | 31% | 21% | worse than chance | 0.56R |
| 5m | smc_choch_up | 218 | 37% | 25% | 17% | 85% | 27% | 17% | beats chance | 0.89R |
| 5m | smc_choch_down | 216 | 26% | 16% | 12% | 87% | 31% | 20% | can't tell from chance | 0.52R |
| 5m | smc_fvg_retrace_bull | 3265 | 29% | 20% | 14% | 81% | 27% | 19% | beats chance | 0.87R |
...
| **ETH** | UNCLEAR (weak) | WEAK_BULL (weak) | UNCLEAR (weak) | WEAK_BULL (weak) | LONG allowed (1D/1H bullish, 1W UNCLEAR) |
...
| **SUI** | RANGE (weak) | TRANSITION (weak) | WEAK_BULL (weak) | STRONG_BULL (moderate) | LONG allowed (4H/1H bullish, 1W RANGE) |
...
- **1H RANGE (strong)** - for: EMAs not lined up; EMA-fast flat (-0.2 ATR in 10 candles); swing structure mixed; ADX 15 = weak trend / ranging; candle size 0.92x normal, Bollinger width above 21% of the last 100 candles · against: -
...
|---|---|---|---|---|---|---|---|
| **BTC** | up (CHOCH 36 candles ago) | sell-side (bullish idea) 24 candles ago | bull 83,810.01-83,902.69 | bear 86,133.40-86,975.51 | discount (40%) | swing high 85,255.00 (2.46 ATR) | swing low 83,183.00 (1.66 ATR) |
| **ETH** | up (BOS 36 candles ago) | sell-side (bullish idea) 17 candles ago | bull 2,686.36-2,690.62 (retraced) | bear 2,745.99-2,784.40 | discount (33%) | swing high 2,743.00 (2.35 ATR) | equal lows 2,667.33 (1.23 ATR) |
| **XRP** | up (CHOCH 32 candles ago) | sell-side (bullish idea) 13 candles ago | bear 1.6015-1.6117 (retraced) | bull 1.3773-1.3856 | discount (32%) | swing high 1.6300 (2.38 ATR) | swing low 1.5444 (1.13 ATR) |
| **SOL** | up (BOS 8 candles ago) | buy-side (bearish idea) 7 candles ago | bull 121.05-121.68 (retraced) | bull 115.86-117.34 | premium (90%) | - | swing low 118.27 (2.39 ATR) |
| **ZEC** | down (BOS 11 candles ago) | sell-side (bullish idea) 10 candles ago | bear 1,552.70-1,556.14 | bull 1,098.88-1,133.82 | discount (10%) | swing high 1,625.00 (2.76 ATR) | swing low 1,456.92 (2.98 ATR) |
| **SUI** | up (BOS 1 candles ago) | buy-side (bearish idea) 0 candles ago | bull 1.0755-1.0969 (retraced) | bull 1.0050-1.0598 | premium (75%) | swing high 1.1615 (0.65 ATR) | swing low 1.0901 (1.98 ATR) |
| **ENA** | up (BOS 16 candles ago) | buy-side (bearish idea) 22 candles ago | bull 0.25770-0.25950 | bull 0.16130-0.17050 | premium (95%) | swing high 0.26420 (0.29 ATR) | swing low 0.21880 (5.75 ATR) |
...
| donchian_breakout | 1.0 | 30m | **FAILED** | 1282 | 48.7 | -0.080 | 0.85 | 130.7R | -0.09 / -0.05 | -0.05 / -0.11 | 1/5 ✗ | -0.15 | ✗  stop atr 2.0→1.6: -0.15R | 2 | 0.13R | 48, -0.04 (-0.15 / +0.08) | 137 / 60 of 443 | 0 | avg -0.08R/trade (needs +0.10R); profit factor 0.85; max drawdown 130.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7315 | 54.0 | -0.125 | 0.55 | 916.8R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 42, -0.15 (-0.27 / +0.00) | 1006 / 6 of 1367 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.55; max drawdown 916.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6580 | 47.1 | -0.146 | 0.75 | 977.2R | -0.14 / -0.15 | -0.19 / -0.10 | 0/5 ✗ | -0.22 | ✗  stop atr 1.5→1.2: -0.18R | 0 | 0.13R | 46, +0.14 (-0.13 / +0.45) | 1209 / 320 of 1901 | 0 | avg -0.15R/trade (needs +0.10R); profit factor 0.75; max drawdown 977.2R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 1h | **FAILED** | 868 | 32.3 | -0.176 | 0.78 | 182.4R | -0.13 / -0.26 | -0.22 / -0.14 | 1/5 ✗ | -0.28 | ✗  stop buffer_atr 0.2→0.16: -0.22R | 1 | 0.21R | 10, +0.20 (+0.87 / -0.48) | 481 / 1191 of 1753 | 0 | avg -0.18R/trade (needs +0.10R); profit factor 0.78; max drawdown 182.4R; not profitable in BOTH train and unseen test |
...
| ema_9_21_cross | 1.0 | 15m | **FAILED** | 449 | 44.3 | -0.195 | 0.68 | 94.2R | -0.21 / -0.15 | -0.26 / -0.16 | 1/5 ✗ | -0.35 | ✗  stop atr 1.5→1.2: -0.30R | 1 | 0.27R | 21, +0.00 (+0.14 / -0.34) | 65 / 18 of 107 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.19R/trade (needs +0.10R); profit factor 0.68; max drawdown 94.2R; not profitable in BOTH train and unseen test |
| trend_pullback | 1.0 | 30m | **FAILED** | 3435 | 46.0 | -0.201 | 0.68 | 711.9R | -0.19 / -0.23 | -0.23 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.19R | 82, +0.15 (+0.14 / +0.16) | 825 / 248 of 1696 | 0 | avg -0.20R/trade (needs +0.10R); profit factor 0.68; max drawdown 711.9R; not profitable in BOTH train and unseen test |
| rsi2_dip_buy | 1.0 | 30m | **FAILED** | 2795 | 45.9 | -0.211 | 0.37 | 592.4R | -0.19 / -0.25 | -0.25 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 2.0→1.6: -0.27R | 0 | 0.18R | 36, -0.11 (-0.20 / +0.13) | 1045 / 25 of 1262 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.37; max drawdown 592.4R; not profitable in BOTH train and unseen test |
| S6-OB-FVG-noSMC | 1.0 | 15m | **FAILED** | 37 | 35.1 | -0.212 | 0.69 | 11.1R | +0.05 / -0.59 | -0.46 / -0.00 | 1/5 ✗ | -0.32 | ✗  time_stop_bars 30→24: -0.26R | 2 | 0.16R | 6, -0.26 (+0.17 / -0.48) | 105 / 32 of 149 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.69; max drawdown 11.1R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 15m | **FAILED** | 2983 | 45.0 | -0.256 | 0.61 | 771.7R | -0.25 / -0.28 | -0.30 / -0.23 | 0/5 ✗ | -0.42 | ✗  stop atr 1.5→1.2: -0.34R | 0 | 0.27R | 164, -0.08 (-0.18 / +0.04) | 1356 / 355 of 2296 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.26R/trade (needs +0.10R); profit factor 0.61; max drawdown 771.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2143 | 32.7 | -0.356 | 0.19 | 763.4R | -0.35 / -0.38 | -0.44 / -0.28 | 0/5 ✗ | -0.53 | ✗  hi 90→108: -0.44R | 0 | 0.30R | 58, -0.28 (-0.29 / -0.25) | 1189 / 33 of 1357 | 0 | not cost-viable: fees + slippage 0.30R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.19; max drawdown 763.4R; not profitable in BOTH train and unseen test |
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 540 | 41.9 | -0.357 | 0.5 | 193.9R | -0.35 / -0.37 | -0.32 / -0.38 | 0/5 ✗ | -0.52 | ✗  stop atr 1.5→1.2: -0.43R | 0 | 0.31R | 37, -0.65 (-0.44 / -0.97) | 112 / 50 of 217 | 0 | not cost-viable: fees + slippage 0.31R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.50; max drawdown 193.9R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 616 | 25.5 | -0.442 | 0.55 | 280.8R | -0.46 / -0.40 | -0.58 / -0.34 | 0/5 ✗ | -0.61 | ✗  n 20→24: -0.47R | 1 | 0.35R | 17, +0.15 (+0.64 / -0.41) | 455 / 1091 of 1734 | 0 | not cost-viable: fees + slippage 0.35R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.55; max drawdown 280.8R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 30m | **FAILED** | 329 | 39.2 | -0.444 | 0.4 | 146.5R | -0.41 / -0.54 | -0.44 / -0.45 | 0/5 ✗ | -0.60 | ✗  stop atr 1.0→0.8: -0.48R | 0 | 0.29R | 11, -0.51 (-0.29 / -0.69) | 117 / 220 of 362 | 0 | not cost-viable: fees + slippage 0.29R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.40; max drawdown 146.5R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 15m | **FAILED** | 567 | 38.6 | -0.507 | 0.37 | 289.3R | -0.50 / -0.52 | -0.59 / -0.47 | 0/5 ✗ | -0.72 | ✗  stop atr 1.0→0.8: -0.55R | 0 | 0.39R | 27, -0.52 (-0.60 / -0.46) | 100 / 239 of 370 | 0 | not cost-viable: fees + slippage 0.39R per trade (stop must be ≥ 4x the round-trip cost); avg -0.51R/trade (needs +0.10R); profit factor 0.37; max drawdown 289.3R; not profitable in BOTH train and unseen test |
