...
**Updated:** 2026-09-25 14:23 Beijing time (2026-09-25 06:23 UTC) · data: Binance · 10 coins scanned
...
```
POSITION BOOK — 2026-09-25 06:23 UTC / 2026-09-25 14:23 Beijing
...
|---|---|---|
| ONDO | $137M | 7-day average volume $43M < $50M; 24h move +25.6% is beyond ±25% - suspended for the rest of the UTC day; order book too thin: $184k within 1% (need $250k) |
| PROVE | $112M | order book too thin: $59k within 1% (need $250k) |
| SAGA | $73M | 7-day average volume $21M < $50M; 24h move -26.1% is beyond ±25% - suspended for the rest of the UTC day; order book too thin: $17k within 1% (need $250k) |
...
|---|---|---|---|---|---|---|
| BTC | mixed (LH/HL) | 84,888 / 83,948.4 | 0.39 | 0.39x | 0.85x | bear_engulf |
| ETH | mixed (LH/HL) | 2,700.21 / 2,676.03 | 0.46 | 0.40x | 0.84x | - |
| XRP | mixed (HH/LL) | 1.5612 / 1.4517 | 0.12 | 0.59x | 0.86x | - |
| SOL | up (HH/HL) | 118.44 / 116.12 | 0.55 | 0.68x | 0.86x | bear_div |
| ZEC | up (HH/HL) | 1,574.6 / 1,533.12 | 0.12 | 0.42x | 0.90x | bear_reject |
| LTC | mixed (LH/HL) | 72.29 / 70.38 | 0.82 | 0.22x | 1.48x | - |
| BNB | mixed (LH/HL) | 780.08 / 775.35 | 0.88 | 0.86x | 0.74x | bull_reject |
...
| 1h | bear_engulf | 1885 | 39% | 25% | 17% | 80% | 38% | 25% | can't tell from chance | 0.19R |
...
| 1h | smc_sweep_bull | 640 | 40% | 25% | 18% | 78% | 42% | 29% | can't tell from chance | 0.31R |
| 1h | smc_sweep_bear | 706 | 37% | 24% | 16% | 81% | 39% | 25% | can't tell from chance | 0.19R |
| 1h | smc_bos_up | 412 | 43% | 31% | 23% | 79% | 44% | 30% | can't tell from chance | 0.27R |
| 1h | smc_bos_down | 277 | 38% | 27% | 18% | 82% | 40% | 25% | can't tell from chance | 0.21R |
| 1h | smc_choch_up | 113 | 50% | 36% | 30% | 71% | 44% | 31% | can't tell from chance | 0.33R |
| 1h | smc_choch_down | 113 | 46% | 29% | 16% | 73% | 39% | 25% | can't tell from chance | 0.17R |
| 1h | smc_fvg_retrace_bull | 890 | 44% | 32% | 24% | 72% | 42% | 29% | can't tell from chance | 0.30R |
| 1h | smc_fvg_retrace_bear | 808 | 41% | 28% | 19% | 77% | 38% | 25% | can't tell from chance | 0.20R |
| 30m | displacement_up | 643 | 42% | 31% | 26% | 77% | 41% | 29% | can't tell from chance | 0.30R |
| 30m | displacement_down | 416 | 39% | 24% | 14% | 83% | 36% | 22% | can't tell from chance | 0.20R |
| 30m | bull_engulf | 1726 | 41% | 29% | 20% | 76% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | bear_engulf | 1755 | 35% | 21% | 14% | 82% | 36% | 21% | can't tell from chance | 0.22R |
| 30m | bull_reject | 1344 | 44% | 29% | 21% | 73% | 41% | 29% | beats chance | 0.36R |
| 30m | bear_reject | 1399 | 37% | 23% | 15% | 81% | 36% | 22% | can't tell from chance | 0.21R |
| 30m | smc_sweep_bull | 624 | 40% | 26% | 17% | 76% | 41% | 28% | can't tell from chance | 0.36R |
| 30m | smc_sweep_bear | 630 | 41% | 26% | 17% | 83% | 35% | 21% | beats chance | 0.21R |
| 30m | smc_bos_up | 469 | 41% | 33% | 27% | 76% | 41% | 28% | can't tell from chance | 0.33R |
| 30m | smc_bos_down | 230 | 34% | 22% | 13% | 86% | 37% | 23% | can't tell from chance | 0.24R |
| 30m | smc_choch_up | 101 | 36% | 23% | 17% | 83% | 39% | 29% | can't tell from chance | 0.38R |
| 30m | smc_choch_down | 101 | 37% | 22% | 16% | 82% | 37% | 22% | can't tell from chance | 0.19R |
| 30m | smc_fvg_retrace_bull | 989 | 42% | 29% | 22% | 75% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | smc_fvg_retrace_bear | 825 | 38% | 22% | 16% | 81% | 36% | 22% | can't tell from chance | 0.24R |
| 15m | displacement_up | 482 | 36% | 27% | 20% | 82% | 36% | 25% | can't tell from chance | 0.43R |
| 15m | displacement_down | 451 | 34% | 21% | 13% | 85% | 37% | 23% | can't tell from chance | 0.28R |
| 15m | bull_engulf | 1664 | 37% | 27% | 19% | 78% | 35% | 25% | can't tell from chance | 0.51R |
| 15m | bear_engulf | 1611 | 36% | 24% | 15% | 79% | 36% | 22% | can't tell from chance | 0.30R |
| 15m | bull_reject | 1328 | 35% | 23% | 16% | 80% | 35% | 25% | can't tell from chance | 0.52R |
| 15m | bear_reject | 1471 | 35% | 22% | 14% | 81% | 36% | 22% | can't tell from chance | 0.29R |
| 15m | smc_sweep_bull | 593 | 37% | 25% | 20% | 78% | 37% | 26% | can't tell from chance | 0.47R |
| 15m | smc_sweep_bear | 631 | 38% | 25% | 15% | 83% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | smc_bos_up | 356 | 39% | 28% | 22% | 80% | 38% | 26% | can't tell from chance | 0.43R |
| 15m | smc_bos_down | 345 | 34% | 20% | 14% | 85% | 35% | 21% | can't tell from chance | 0.33R |
| 15m | smc_choch_up | 86 | 36% | 24% | 19% | 79% | 37% | 27% | can't tell from chance | 0.45R |
| 15m | smc_choch_down | 84 | 32% | 21% | 14% | 81% | 36% | 25% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 1019 | 33% | 23% | 16% | 80% | 35% | 24% | can't tell from chance | 0.49R |
| 15m | smc_fvg_retrace_bear | 966 | 36% | 25% | 17% | 80% | 36% | 22% | can't tell from chance | 0.31R |
| 5m | displacement_up | 1198 | 31% | 21% | 16% | 84% | 28% | 19% | beats chance | 0.80R |
| 5m | displacement_down | 1129 | 29% | 19% | 13% | 86% | 31% | 21% | can't tell from chance | 0.53R |
| 5m | bull_engulf | 4131 | 26% | 18% | 13% | 83% | 28% | 19% | can't tell from chance | 0.88R |
| 5m | bear_engulf | 4078 | 32% | 21% | 14% | 83% | 31% | 21% | can't tell from chance | 0.54R |
| 5m | bull_reject | 3469 | 27% | 18% | 14% | 81% | 27% | 19% | can't tell from chance | 0.91R |
| 5m | bear_reject | 3689 | 32% | 21% | 15% | 82% | 31% | 21% | can't tell from chance | 0.52R |
| 5m | smc_sweep_bull | 1229 | 31% | 22% | 15% | 79% | 29% | 20% | beats chance | 0.79R |
| 5m | smc_sweep_bear | 1282 | 35% | 24% | 17% | 81% | 32% | 21% | can't tell from chance | 0.45R |
| 5m | smc_bos_up | 819 | 29% | 21% | 16% | 85% | 28% | 19% | can't tell from chance | 0.83R |
| 5m | smc_bos_down | 882 | 29% | 19% | 12% | 86% | 31% | 21% | can't tell from chance | 0.57R |
| 5m | smc_choch_up | 215 | 36% | 24% | 16% | 86% | 29% | 21% | beats chance | 0.91R |
| 5m | smc_choch_down | 218 | 28% | 17% | 13% | 85% | 31% | 21% | can't tell from chance | 0.53R |
| 5m | smc_fvg_retrace_bull | 3260 | 28% | 19% | 13% | 82% | 27% | 19% | can't tell from chance | 0.89R |
| 5m | smc_fvg_retrace_bear | 2947 | 28% | 19% | 12% | 84% | 31% | 20% | worse than chance | 0.55R |
...
|---|---|---|---|---|---|
| **BTC** | TRANSITION (weak) | WEAK_BULL (moderate) | TRANSITION (moderate) | RANGE (strong) | NO TRADE (timeframes disagree (1D WEAK_BULL, 4H TRANSITION, 1H RANGE)) |
...
| **BNB** | WEAK_BULL (weak) | STRONG_BULL (moderate) | UNCLEAR (weak) | RANGE (strong) | NO TRADE (timeframes disagree (1D STRONG_BULL, 4H UNCLEAR, 1H RANGE)) |
...
- **1H RANGE (strong)** - for: EMAs not lined up; EMA-fast flat (-0.1 ATR in 10 candles); swing structure mixed; ADX 17 = weak trend / ranging; candle size 0.85x normal, Bollinger width above 13% of the last 100 candles · against: -
...
|---|---|---|---|---|---|---|---|
| **BTC** | down (BOS 13 candles ago) | sell-side (bullish idea) 0 candles ago | bear 84,328.01-84,404.01 (retraced) | bear 86,133.40-86,975.51 | discount (26%) | equal highs 84,942.45 (1.57 ATR) | swing low 83,948.43 (0.51 ATR) |
| **ETH** | down (BOS 13 candles ago) | sell-side (bullish idea) 0 candles ago | bear 2,684.01-2,688.81 (retraced) | bear 2,745.99-2,784.40 | discount (16%) | swing high 2,700.21 (1.05 ATR) | swing low 2,600.15 (4.13 ATR) |
| **XRP** | down (CHOCH 14 candles ago) | sell-side (bullish idea) 0 candles ago | bull 1.5156-1.5195 (retraced) | bull 1.3773-1.3856 | premium (70%) | swing high 1.5612 (1.7 ATR) | swing low 1.4517 (3.92 ATR) |
| **SOL** | up (BOS 16 candles ago) | buy-side (bearish idea) 20 candles ago | bear 117.50-117.83 | bear 117.85-119.66 | discount (14%) | swing high 118.44 (1.9 ATR) | swing low 116.12 (0.3 ATR) |
| **ZEC** | up (BOS 24 candles ago) | sell-side (bullish idea) 13 candles ago | bull 1,517.23-1,526.13 (retraced) | bull 1,098.88-1,133.82 | discount (26%) | swing high 1,574.60 (1.2 ATR) | swing low 1,533.12 (0.42 ATR) |
| **LTC** | up (BOS 34 candles ago) | buy-side (bearish idea) 0 candles ago | bear 72.340-72.720 (retraced) | bull 58.800-63.080 | discount (40%) | swing high 72.290 (0.76 ATR) | swing low 65.520 (3.75 ATR) |
| **BNB** | down (CHOCH 13 candles ago) | sell-side (bullish idea) 14 candles ago | bull 773.88-774.54 (retraced) | bear 787.07-797.61 | below the range (-11%) | swing high 780.08 (1.18 ATR) | equal lows 763.04 (2.65 ATR) |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7315 | 54.0 | -0.125 | 0.55 | 916.8R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 36, -0.19 (-0.28 / -0.01) | 1010 / 6 of 1359 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.55; max drawdown 916.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6580 | 47.1 | -0.146 | 0.75 | 977.2R | -0.14 / -0.15 | -0.19 / -0.10 | 0/5 ✗ | -0.22 | ✗  stop atr 1.5→1.2: -0.18R | 0 | 0.13R | 44, +0.09 (-0.20 / +0.41) | 1200 / 318 of 1887 | 0 | avg -0.15R/trade (needs +0.10R); profit factor 0.75; max drawdown 977.2R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 1h | **FAILED** | 868 | 32.3 | -0.176 | 0.78 | 182.4R | -0.13 / -0.26 | -0.22 / -0.14 | 1/5 ✗ | -0.28 | ✗  stop buffer_atr 0.2→0.16: -0.22R | 1 | 0.21R | 10, -0.18 (+0.20 / -0.57) | 485 / 1185 of 1750 | 0 | avg -0.18R/trade (needs +0.10R); profit factor 0.78; max drawdown 182.4R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 30m | **FAILED** | 3435 | 46.0 | -0.201 | 0.68 | 711.9R | -0.19 / -0.23 | -0.23 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.19R | 77, +0.17 (+0.18 / +0.16) | 806 / 249 of 1677 | 0 | avg -0.20R/trade (needs +0.10R); profit factor 0.68; max drawdown 711.9R; not profitable in BOTH train and unseen test |
| rsi2_dip_buy | 1.0 | 30m | **FAILED** | 2795 | 45.9 | -0.211 | 0.37 | 592.4R | -0.19 / -0.25 | -0.25 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 2.0→1.6: -0.27R | 0 | 0.18R | 33, -0.12 (-0.18 / +0.08) | 1045 / 25 of 1257 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.37; max drawdown 592.4R; not profitable in BOTH train and unseen test |
| S6-OB-FVG-noSMC | 1.0 | 15m | **FAILED** | 37 | 35.1 | -0.212 | 0.69 | 11.1R | +0.05 / -0.59 | -0.46 / -0.00 | 1/5 ✗ | -0.32 | ✗  time_stop_bars 30→24: -0.26R | 2 | 0.16R | 6, -0.26 (+1.40 / -0.59) | 109 / 35 of 158 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.69; max drawdown 11.1R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2143 | 32.7 | -0.356 | 0.19 | 763.4R | -0.35 / -0.38 | -0.44 / -0.28 | 0/5 ✗ | -0.53 | ✗  hi 90→108: -0.44R | 0 | 0.30R | 56, -0.25 (-0.29 / -0.07) | 1195 / 35 of 1377 | 0 | not cost-viable: fees + slippage 0.30R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.19; max drawdown 763.4R; not profitable in BOTH train and unseen test |
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 540 | 41.9 | -0.357 | 0.5 | 193.9R | -0.35 / -0.37 | -0.32 / -0.38 | 0/5 ✗ | -0.52 | ✗  stop atr 1.5→1.2: -0.43R | 0 | 0.31R | 36, -0.72 (-0.47 / -1.05) | 109 / 46 of 211 | 0 | not cost-viable: fees + slippage 0.31R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.50; max drawdown 193.9R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 419 | 26.0 | -1.175 | 0.15 | 495.0R | -1.26 / -1.07 | -1.08 / -1.65 | 0/5 ✗ | -1.86 | ✗  stop atr 1.0→0.8: -1.53R | 0 | 1.08R | 112, -1.18 (-1.37 / -0.97) | 188 / 630 of 939 | 0 | not cost-viable: fees + slippage 1.08R per trade (stop must be ≥ 4x the round-trip cost); avg -1.17R/trade (needs +0.10R); profit factor 0.15; max drawdown 495.0R; not profitable in BOTH train and unseen test |
