...
**Updated:** 2026-09-25 12:18 Beijing time (2026-09-25 04:18 UTC) · data: Binance · 10 coins scanned
...
```
POSITION BOOK — 2026-09-25 04:18 UTC / 2026-09-25 12:18 Beijing
...
- **Changes this run** (also written to `memory/universe_log.md`):
  - **EXCLUDED** SAGA - 7-day average volume $21M < $50M; 24h move -33.3% is beyond ±25% - suspended for the rest of the UTC day; spread 0.131% > 0.1%; order book too thin: $6k within 1% (need $250k)
  - **EXCLUDED** AVAX - order book too thin: $231k within 1% (need $250k)

| Not eligible | 24h volume | Why |
|---|---|---|
| PROVE | $147M | order book too thin: $66k within 1% (need $250k) |
| ONDO | $134M | 7-day average volume $43M < $50M; 24h move +27.2% is beyond ±25% - suspended for the rest of the UTC day; order book too thin: $209k within 1% (need $250k) |
| SAGA | $69M | 7-day average volume $21M < $50M; 24h move -33.3% is beyond ±25% - suspended for the rest of the UTC day; spread 0.131% > 0.1%; order book too thin: $6k within 1% (need $250k) |
| LINK | $55M | 7-day average volume $44M < $50M |
| AVAX | $51M | order book too thin: $231k within 1% (need $250k) |
...
|---|---|---|---|---|---|---|
| BTC | up (HH/HL) | 84,942.4 / 83,948.4 | 0.52 | 0.49x | 0.92x | bear_engulf |
| ETH | up (HH/HL) | 2,706 / 2,676.03 | 0.70 | 0.51x | 0.89x | - |
| XRP | mixed (HH/LL) | 1.5612 / 1.4517 | 0.64 | 0.78x | 0.91x | - |
| SOL | up (HH/HL) | 117.79 / 116.12 | 0.49 | 0.65x | 0.90x | bear_engulf |
| ZEC | up (HH/HL) | 1,574.6 / 1,523.32 | 0.82 | 0.60x | 0.96x | bear_reject |
| LTC | mixed (LH/HL) | 72.42 / 70.38 | 0.33 | 0.27x | 1.58x | - |
| BNB | up (HH/HL) | 786.29 / 775.35 | 0.54 | 0.94x | 0.79x | bear_engulf |
...
| 1h | displacement_down | 435 | 37% | 23% | 14% | 81% | 40% | 27% | can't tell from chance | 0.18R |
...
| 1h | bear_reject | 1334 | 35% | 24% | 17% | 82% | 38% | 25% | worse than chance | 0.18R |
| 1h | smc_sweep_bull | 640 | 40% | 25% | 18% | 78% | 43% | 30% | can't tell from chance | 0.31R |
| 1h | smc_sweep_bear | 706 | 37% | 24% | 16% | 81% | 38% | 25% | can't tell from chance | 0.19R |
| 1h | smc_bos_up | 407 | 43% | 30% | 23% | 78% | 42% | 28% | can't tell from chance | 0.27R |
| 1h | smc_bos_down | 278 | 37% | 27% | 18% | 82% | 39% | 25% | can't tell from chance | 0.21R |
| 1h | smc_choch_up | 114 | 50% | 37% | 30% | 71% | 42% | 31% | can't tell from chance | 0.33R |
| 1h | smc_choch_down | 112 | 46% | 29% | 16% | 73% | 40% | 26% | can't tell from chance | 0.17R |
| 1h | smc_fvg_retrace_bull | 887 | 44% | 32% | 24% | 72% | 42% | 29% | can't tell from chance | 0.30R |
| 1h | smc_fvg_retrace_bear | 806 | 41% | 28% | 19% | 78% | 38% | 25% | can't tell from chance | 0.20R |
| 30m | displacement_up | 630 | 42% | 32% | 26% | 77% | 42% | 30% | can't tell from chance | 0.30R |
| 30m | displacement_down | 408 | 39% | 24% | 14% | 83% | 37% | 22% | can't tell from chance | 0.20R |
| 30m | bull_engulf | 1729 | 41% | 29% | 20% | 76% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | bear_engulf | 1753 | 35% | 21% | 15% | 82% | 36% | 21% | can't tell from chance | 0.22R |
| 30m | bull_reject | 1350 | 44% | 29% | 21% | 73% | 41% | 29% | beats chance | 0.36R |
| 30m | bear_reject | 1402 | 37% | 23% | 15% | 81% | 36% | 22% | can't tell from chance | 0.21R |
| 30m | smc_sweep_bull | 624 | 40% | 26% | 17% | 76% | 41% | 28% | can't tell from chance | 0.36R |
| 30m | smc_sweep_bear | 629 | 41% | 26% | 17% | 83% | 35% | 21% | beats chance | 0.21R |
| 30m | smc_bos_up | 464 | 41% | 33% | 27% | 77% | 42% | 30% | can't tell from chance | 0.33R |
| 30m | smc_bos_down | 231 | 34% | 22% | 13% | 86% | 39% | 22% | can't tell from chance | 0.24R |
| 30m | smc_choch_up | 98 | 37% | 23% | 17% | 83% | 42% | 30% | can't tell from chance | 0.38R |
| 30m | smc_choch_down | 101 | 37% | 22% | 16% | 82% | 35% | 21% | can't tell from chance | 0.19R |
| 30m | smc_fvg_retrace_bull | 983 | 41% | 28% | 22% | 75% | 41% | 28% | can't tell from chance | 0.37R |
| 30m | smc_fvg_retrace_bear | 822 | 38% | 22% | 16% | 81% | 35% | 21% | can't tell from chance | 0.24R |
| 15m | displacement_up | 482 | 36% | 27% | 20% | 82% | 36% | 26% | can't tell from chance | 0.43R |
| 15m | displacement_down | 451 | 33% | 21% | 13% | 85% | 36% | 23% | can't tell from chance | 0.28R |
| 15m | bull_engulf | 1664 | 37% | 27% | 19% | 78% | 35% | 24% | can't tell from chance | 0.51R |
| 15m | bear_engulf | 1607 | 36% | 24% | 15% | 79% | 36% | 22% | can't tell from chance | 0.30R |
| 15m | bull_reject | 1337 | 35% | 23% | 16% | 80% | 35% | 24% | can't tell from chance | 0.52R |
| 15m | bear_reject | 1470 | 36% | 22% | 14% | 81% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | smc_sweep_bull | 590 | 37% | 25% | 20% | 78% | 37% | 26% | can't tell from chance | 0.47R |
| 15m | smc_sweep_bear | 630 | 38% | 25% | 15% | 83% | 37% | 23% | can't tell from chance | 0.29R |
| 15m | smc_bos_up | 353 | 38% | 27% | 21% | 81% | 36% | 26% | can't tell from chance | 0.43R |
| 15m | smc_bos_down | 346 | 34% | 20% | 14% | 85% | 36% | 22% | can't tell from chance | 0.33R |
| 15m | smc_choch_up | 90 | 37% | 24% | 19% | 79% | 35% | 24% | can't tell from chance | 0.46R |
| 15m | smc_choch_down | 85 | 32% | 21% | 14% | 81% | 38% | 24% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 1016 | 33% | 23% | 16% | 80% | 35% | 24% | can't tell from chance | 0.49R |
| 15m | smc_fvg_retrace_bear | 974 | 37% | 25% | 17% | 79% | 36% | 22% | can't tell from chance | 0.31R |
| 5m | displacement_up | 1197 | 31% | 21% | 16% | 84% | 28% | 19% | beats chance | 0.80R |
| 5m | displacement_down | 1145 | 29% | 19% | 13% | 86% | 31% | 21% | can't tell from chance | 0.53R |
| 5m | bull_engulf | 4137 | 26% | 18% | 13% | 83% | 27% | 19% | can't tell from chance | 0.89R |
| 5m | bear_engulf | 4062 | 32% | 21% | 14% | 83% | 31% | 21% | can't tell from chance | 0.55R |
| 5m | bull_reject | 3484 | 27% | 18% | 14% | 82% | 28% | 19% | can't tell from chance | 0.91R |
| 5m | bear_reject | 3684 | 32% | 21% | 15% | 82% | 31% | 21% | can't tell from chance | 0.52R |
| 5m | smc_sweep_bull | 1230 | 31% | 22% | 15% | 79% | 29% | 20% | can't tell from chance | 0.79R |
| 5m | smc_sweep_bear | 1285 | 34% | 24% | 16% | 81% | 32% | 22% | can't tell from chance | 0.45R |
| 5m | smc_bos_up | 814 | 29% | 21% | 17% | 85% | 27% | 19% | can't tell from chance | 0.83R |
| 5m | smc_bos_down | 891 | 29% | 20% | 12% | 85% | 31% | 20% | can't tell from chance | 0.57R |
| 5m | smc_choch_up | 215 | 36% | 24% | 16% | 86% | 28% | 20% | beats chance | 0.92R |
| 5m | smc_choch_down | 212 | 27% | 17% | 13% | 86% | 31% | 21% | can't tell from chance | 0.52R |
| 5m | smc_fvg_retrace_bull | 3244 | 28% | 19% | 13% | 82% | 27% | 19% | can't tell from chance | 0.89R |
| 5m | smc_fvg_retrace_bear | 2957 | 28% | 19% | 12% | 85% | 31% | 20% | worse than chance | 0.55R |
...
| **ENA** | TRANSITION (weak) | WEAK_BULL (weak) | WEAK_BULL (weak) | EXPANSION down (weak) | LONG allowed (1D/4H bullish, 1W TRANSITION) |
...
- **1H RANGE (weak)** - for: EMAs not lined up; EMA-fast flat (-0.1 ATR in 10 candles); ADX 19 = weak trend / ranging; candle size 0.92x normal, Bollinger width above 46% of the last 100 candles · against: swing structure up (HH/HL); ADX 19 is close to a threshold
...
|---|---|---|---|---|---|---|---|
| **BTC** | down (BOS 5 candles ago) | buy-side (bearish idea) 12 candles ago | bear 84,328.01-84,404.01 (retraced) | bear 86,133.40-86,975.51 | discount (28%) | swing high 84,942.45 (1.38 ATR) | swing low 83,948.43 (0.55 ATR) |
| **ETH** | down (BOS 5 candles ago) | sell-side (bullish idea) 5 candles ago | bear 2,684.01-2,688.81 | bear 2,745.99-2,784.40 | discount (10%) | equal highs 2,706.00 (1.31 ATR) | swing low 2,600.15 (3.84 ATR) |
| **XRP** | down (CHOCH 6 candles ago) | sell-side (bullish idea) 5 candles ago | bear 1.5330-1.5410 (retraced) | bull 1.3773-1.3856 | premium (72%) | swing high 1.5612 (1.49 ATR) | swing low 1.4517 (3.83 ATR) |
| **SOL** | up (BOS 8 candles ago) | buy-side (bearish idea) 12 candles ago | bear 117.50-117.83 | bear 117.85-119.66 | discount (47%) | swing high 119.77 (2.62 ATR) | swing low 116.12 (0.71 ATR) |
| **ZEC** | up (BOS 16 candles ago) | sell-side (bullish idea) 5 candles ago | bull 1,517.23-1,526.13 (retraced) | bull 1,098.88-1,133.82 | premium (67%) | swing high 1,574.60 (0.62 ATR) | swing low 1,523.32 (1.26 ATR) |
| **LTC** | up (BOS 26 candles ago) | sell-side (bullish idea) 6 candles ago | bear 72.340-72.720 (retraced) | bull 58.800-63.080 | discount (17%) | swing high 72.420 (1.07 ATR) | swing low 65.520 (3.29 ATR) |
| **BNB** | down (CHOCH 5 candles ago) | sell-side (bullish idea) 6 candles ago | bear 776.30-777.26 | bear 787.07-797.61 | below the range (-21%) | swing high 786.29 (2.8 ATR) | equal lows 763.04 (2.13 ATR) |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7315 | 54.0 | -0.125 | 0.55 | 916.8R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 34, -0.20 (-0.28 / -0.01) | 1010 / 6 of 1359 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.55; max drawdown 916.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6580 | 47.1 | -0.146 | 0.75 | 977.2R | -0.14 / -0.15 | -0.19 / -0.10 | 0/5 ✗ | -0.22 | ✗  stop atr 1.5→1.2: -0.18R | 0 | 0.13R | 44, +0.09 (-0.18 / +0.35) | 1201 / 317 of 1885 | 0 | avg -0.15R/trade (needs +0.10R); profit factor 0.75; max drawdown 977.2R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 30m | **FAILED** | 3435 | 46.0 | -0.201 | 0.68 | 711.9R | -0.19 / -0.23 | -0.23 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.19R | 77, +0.17 (+0.18 / +0.16) | 805 / 247 of 1673 | 0 | avg -0.20R/trade (needs +0.10R); profit factor 0.68; max drawdown 711.9R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 15m | **FAILED** | 2983 | 45.0 | -0.256 | 0.61 | 771.7R | -0.25 / -0.28 | -0.30 / -0.23 | 0/5 ✗ | -0.42 | ✗  stop atr 1.5→1.2: -0.34R | 0 | 0.27R | 160, -0.07 (-0.16 / +0.04) | 1334 / 345 of 2257 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.26R/trade (needs +0.10R); profit factor 0.61; max drawdown 771.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2143 | 32.7 | -0.356 | 0.19 | 763.4R | -0.35 / -0.38 | -0.44 / -0.28 | 0/5 ✗ | -0.53 | ✗  hi 90→108: -0.44R | 0 | 0.30R | 57, -0.24 (-0.28 / -0.07) | 1198 / 35 of 1381 | 0 | not cost-viable: fees + slippage 0.30R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.19; max drawdown 763.4R; not profitable in BOTH train and unseen test |
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 540 | 41.9 | -0.357 | 0.5 | 193.9R | -0.35 / -0.37 | -0.32 / -0.38 | 0/5 ✗ | -0.52 | ✗  stop atr 1.5→1.2: -0.43R | 0 | 0.31R | 36, -0.72 (-0.47 / -1.05) | 111 / 46 of 216 | 0 | not cost-viable: fees + slippage 0.31R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.50; max drawdown 193.9R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 616 | 25.5 | -0.442 | 0.55 | 280.8R | -0.46 / -0.40 | -0.58 / -0.34 | 0/5 ✗ | -0.61 | ✗  n 20→24: -0.47R | 1 | 0.35R | 18, +0.08 (-0.49 / +0.53) | 452 / 1076 of 1707 | 0 | not cost-viable: fees + slippage 0.35R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.55; max drawdown 280.8R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 15m | **FAILED** | 567 | 38.6 | -0.507 | 0.37 | 289.3R | -0.50 / -0.52 | -0.59 / -0.47 | 0/5 ✗ | -0.72 | ✗  stop atr 1.0→0.8: -0.55R | 0 | 0.39R | 27, -0.52 (-0.65 / -0.41) | 102 / 235 of 370 | 0 | not cost-viable: fees + slippage 0.39R per trade (stop must be ≥ 4x the round-trip cost); avg -0.51R/trade (needs +0.10R); profit factor 0.37; max drawdown 289.3R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 419 | 26.0 | -1.175 | 0.15 | 495.0R | -1.26 / -1.07 | -1.08 / -1.65 | 0/5 ✗ | -1.86 | ✗  stop atr 1.0→0.8: -1.53R | 0 | 1.08R | 110, -1.17 (-1.37 / -0.95) | 189 / 629 of 936 | 0 | not cost-viable: fees + slippage 1.08R per trade (stop must be ≥ 4x the round-trip cost); avg -1.17R/trade (needs +0.10R); profit factor 0.15; max drawdown 495.0R; not profitable in BOTH train and unseen test |
