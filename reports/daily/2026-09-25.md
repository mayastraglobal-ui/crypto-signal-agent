...
**Updated:** 2026-09-25 15:19 Beijing time (2026-09-25 07:19 UTC) · data: Binance · 10 coins scanned
...
```
POSITION BOOK — 2026-09-25 07:19 UTC / 2026-09-25 15:19 Beijing
...
|---|---|---|
| ONDO | $142M | 7-day average volume $43M < $50M; 24h move +27.5% is beyond ±25% - suspended for the rest of the UTC day; order book too thin: $218k within 1% (need $250k) |
| PROVE | $90M | order book too thin: $53k within 1% (need $250k) |
| SAGA | $74M | 7-day average volume $21M < $50M; suspended for the rest of the UTC day (moved more than ±25% earlier today); order book too thin: $10k within 1% (need $250k) |
| LINK | $56M | 7-day average volume $44M < $50M |
...
| ENA | 129 | 906 | 900 | 1499 | 1999 | 1999 | 1999 | 5000 | 2024-04 | OK (300 candles) |
...
|---|---|---|---|---|---|---|
| BTC | mixed (LH/HL) | 84,888 / 83,948.4 | 0.28 | 0.57x | 0.84x | bear_engulf |
| ETH | mixed (LH/HL) | 2,700.21 / 2,676.03 | 0.37 | 0.60x | 0.83x | - |
| SOL | up (HH/HL) | 118.44 / 116.12 | 0.29 | 0.58x | 0.84x | bear_engulf, bear_div |
| XRP | mixed (HH/LL) | 1.5612 / 1.4517 | 0.61 | 0.54x | 0.84x | - |
| ZEC | up (HH/HL) | 1,574.6 / 1,533.12 | 0.63 | 0.55x | 0.88x | bear_reject |
| LTC | mixed (LH/HL) | 72.29 / 70.38 | 0.59 | 0.33x | 1.42x | - |
| BNB | down (LH/LL) | 780.08 / 771 | 0.10 | 0.43x | 0.73x | bear_engulf, bull_reject |
...
| 1h | displacement_up | 607 | 47% | 34% | 26% | 74% | 42% | 29% | beats chance | 0.27R |
| 1h | displacement_down | 435 | 37% | 23% | 14% | 81% | 38% | 24% | can't tell from chance | 0.18R |
| 1h | bull_engulf | 1718 | 40% | 29% | 22% | 75% | 42% | 29% | can't tell from chance | 0.32R |
| 1h | bear_engulf | 1884 | 39% | 25% | 17% | 80% | 39% | 25% | can't tell from chance | 0.19R |
| 1h | bull_reject | 1417 | 40% | 29% | 22% | 75% | 42% | 29% | can't tell from chance | 0.31R |
| 1h | bear_reject | 1338 | 36% | 24% | 17% | 82% | 39% | 25% | worse than chance | 0.18R |
| 1h | smc_sweep_bull | 639 | 40% | 26% | 18% | 78% | 42% | 30% | can't tell from chance | 0.31R |
| 1h | smc_sweep_bear | 704 | 37% | 24% | 16% | 81% | 38% | 24% | can't tell from chance | 0.19R |
| 1h | smc_bos_up | 412 | 43% | 30% | 23% | 79% | 43% | 29% | can't tell from chance | 0.27R |
| 1h | smc_bos_down | 277 | 38% | 27% | 18% | 82% | 38% | 24% | can't tell from chance | 0.21R |
| 1h | smc_choch_up | 113 | 50% | 36% | 30% | 71% | 41% | 29% | can't tell from chance | 0.33R |
| 1h | smc_choch_down | 113 | 46% | 29% | 16% | 73% | 38% | 25% | can't tell from chance | 0.17R |
| 1h | smc_fvg_retrace_bull | 888 | 44% | 32% | 24% | 72% | 42% | 29% | can't tell from chance | 0.30R |
...
| 30m | bull_engulf | 1723 | 41% | 28% | 20% | 76% | 41% | 29% | can't tell from chance | 0.36R |
...
| 30m | bear_reject | 1403 | 37% | 23% | 15% | 81% | 36% | 22% | can't tell from chance | 0.21R |
| 30m | smc_sweep_bull | 623 | 40% | 26% | 17% | 76% | 41% | 28% | can't tell from chance | 0.36R |
| 30m | smc_sweep_bear | 629 | 41% | 26% | 17% | 83% | 36% | 21% | beats chance | 0.21R |
| 30m | smc_bos_up | 469 | 41% | 33% | 27% | 76% | 42% | 29% | can't tell from chance | 0.33R |
| 30m | smc_bos_down | 230 | 34% | 22% | 13% | 86% | 36% | 21% | can't tell from chance | 0.24R |
| 30m | smc_choch_up | 101 | 36% | 23% | 17% | 83% | 42% | 30% | can't tell from chance | 0.38R |
| 30m | smc_choch_down | 101 | 37% | 22% | 16% | 82% | 35% | 21% | can't tell from chance | 0.19R |
| 30m | smc_fvg_retrace_bull | 990 | 42% | 29% | 22% | 75% | 40% | 28% | can't tell from chance | 0.36R |
...
| 15m | bear_engulf | 1612 | 36% | 24% | 15% | 79% | 35% | 22% | can't tell from chance | 0.30R |
| 15m | bull_reject | 1324 | 35% | 23% | 16% | 80% | 35% | 24% | can't tell from chance | 0.52R |
| 15m | bear_reject | 1468 | 35% | 22% | 14% | 82% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | smc_sweep_bull | 591 | 37% | 26% | 20% | 78% | 37% | 26% | can't tell from chance | 0.47R |
...
| 15m | smc_choch_up | 86 | 36% | 24% | 19% | 79% | 36% | 26% | can't tell from chance | 0.45R |
...
| 15m | smc_fvg_retrace_bear | 968 | 36% | 25% | 17% | 80% | 35% | 22% | can't tell from chance | 0.31R |
| 5m | displacement_up | 1196 | 31% | 21% | 16% | 84% | 28% | 19% | beats chance | 0.80R |
| 5m | displacement_down | 1131 | 29% | 19% | 13% | 86% | 32% | 21% | worse than chance | 0.53R |
| 5m | bull_engulf | 4137 | 26% | 18% | 13% | 83% | 28% | 19% | can't tell from chance | 0.88R |
| 5m | bear_engulf | 4090 | 32% | 21% | 14% | 83% | 31% | 20% | can't tell from chance | 0.54R |
| 5m | bull_reject | 3467 | 27% | 18% | 13% | 82% | 27% | 19% | can't tell from chance | 0.90R |
| 5m | bear_reject | 3694 | 32% | 21% | 15% | 82% | 31% | 21% | can't tell from chance | 0.52R |
| 5m | smc_sweep_bull | 1232 | 31% | 22% | 16% | 79% | 29% | 20% | can't tell from chance | 0.79R |
| 5m | smc_sweep_bear | 1282 | 35% | 24% | 17% | 81% | 32% | 22% | can't tell from chance | 0.45R |
| 5m | smc_bos_up | 834 | 29% | 21% | 16% | 85% | 28% | 20% | can't tell from chance | 0.83R |
| 5m | smc_bos_down | 880 | 29% | 19% | 12% | 86% | 32% | 21% | can't tell from chance | 0.57R |
| 5m | smc_choch_up | 212 | 37% | 25% | 17% | 86% | 27% | 19% | beats chance | 0.90R |
| 5m | smc_choch_down | 219 | 28% | 18% | 13% | 85% | 31% | 20% | can't tell from chance | 0.53R |
| 5m | smc_fvg_retrace_bull | 3246 | 28% | 19% | 13% | 82% | 27% | 19% | can't tell from chance | 0.89R |
| 5m | smc_fvg_retrace_bear | 2951 | 28% | 19% | 12% | 84% | 31% | 20% | worse than chance | 0.55R |
...
- **1H RANGE (strong)** - for: EMAs not lined up; EMA-fast flat (-0.2 ATR in 10 candles); swing structure mixed; ADX 16 = weak trend / ranging; candle size 0.84x normal, Bollinger width above 9% of the last 100 candles · against: -
...
|---|---|---|---|---|---|---|---|
| **BTC** | down (BOS 2 candles ago) | sell-side (bullish idea) 4 candles ago | bear 84,328.01-84,404.01 (retraced) | bear 86,133.40-86,975.51 | discount (9%) | equal highs 84,942.45 (1.94 ATR) | swing low 83,948.43 (0.19 ATR) |
| **ETH** | down (BOS 0 candles ago) | sell-side (bullish idea) 4 candles ago | bear 2,684.01-2,688.81 (retraced) | bear 2,745.99-2,784.40 | below the range (-6%) | swing high 2,700.21 (1.36 ATR) | swing low 2,600.15 (3.94 ATR) |
| **SOL** | up (BOS 20 candles ago) | buy-side (bearish idea) 24 candles ago | bear 117.50-117.83 | bear 117.85-119.66 | discount (7%) | swing high 118.44 (2.11 ATR) | swing low 116.12 (0.16 ATR) |
| **XRP** | down (CHOCH 18 candles ago) | sell-side (bullish idea) 4 candles ago | bull 1.5156-1.5195 (retraced) | bull 1.3773-1.3856 | premium (72%) | swing high 1.5612 (1.63 ATR) | swing low 1.4517 (4.09 ATR) |
| **ZEC** | up (BOS 28 candles ago) | sell-side (bullish idea) 17 candles ago | bull 1,517.23-1,526.13 (retraced) | bull 1,098.88-1,133.82 | discount (30%) | swing high 1,574.60 (1.18 ATR) | swing low 1,533.12 (0.49 ATR) |
| **LTC** | up (BOS 38 candles ago) | buy-side (bearish idea) 4 candles ago | bear 72.340-72.720 (retraced) | bull 58.800-63.080 | premium (52%) | swing high 72.290 (0.64 ATR) | swing low 65.520 (4.04 ATR) |
| **BNB** | down (CHOCH 17 candles ago) | sell-side (bullish idea) 18 candles ago | bear 776.30-777.26 | bear 787.07-797.61 | discount (23%) | swing high 780.08 (1.6 ATR) | swing low 771.00 (0.48 ATR) |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7315 | 54.0 | -0.125 | 0.55 | 916.8R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 36, -0.19 (-0.28 / -0.01) | 1010 / 6 of 1366 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.55; max drawdown 916.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6580 | 47.1 | -0.146 | 0.75 | 977.2R | -0.14 / -0.15 | -0.19 / -0.10 | 0/5 ✗ | -0.22 | ✗  stop atr 1.5→1.2: -0.18R | 0 | 0.13R | 44, +0.09 (-0.20 / +0.41) | 1198 / 319 of 1887 | 0 | avg -0.15R/trade (needs +0.10R); profit factor 0.75; max drawdown 977.2R; not profitable in BOTH train and unseen test |
...
| ema_9_21_cross | 1.0 | 15m | **FAILED** | 449 | 44.3 | -0.195 | 0.68 | 94.2R | -0.21 / -0.15 | -0.26 / -0.16 | 1/5 ✗ | -0.35 | ✗  stop atr 1.5→1.2: -0.30R | 1 | 0.27R | 21, +0.00 (+0.14 / -0.34) | 64 / 18 of 108 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.19R/trade (needs +0.10R); profit factor 0.68; max drawdown 94.2R; not profitable in BOTH train and unseen test |
| trend_pullback | 1.0 | 30m | **FAILED** | 3435 | 46.0 | -0.201 | 0.68 | 711.9R | -0.19 / -0.23 | -0.23 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.19R | 77, +0.17 (+0.18 / +0.16) | 806 / 249 of 1679 | 0 | avg -0.20R/trade (needs +0.10R); profit factor 0.68; max drawdown 711.9R; not profitable in BOTH train and unseen test |
...
| S6-OB-FVG-noSMC | 1.0 | 15m | **FAILED** | 37 | 35.1 | -0.212 | 0.69 | 11.1R | +0.05 / -0.59 | -0.46 / -0.00 | 1/5 ✗ | -0.32 | ✗  time_stop_bars 30→24: -0.26R | 2 | 0.16R | 6, -0.26 (+1.40 / -0.59) | 106 / 35 of 155 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.69; max drawdown 11.1R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2143 | 32.7 | -0.356 | 0.19 | 763.4R | -0.35 / -0.38 | -0.44 / -0.28 | 0/5 ✗ | -0.53 | ✗  hi 90→108: -0.44R | 0 | 0.30R | 56, -0.25 (-0.29 / -0.07) | 1186 / 35 of 1366 | 0 | not cost-viable: fees + slippage 0.30R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.19; max drawdown 763.4R; not profitable in BOTH train and unseen test |
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 540 | 41.9 | -0.357 | 0.5 | 193.9R | -0.35 / -0.37 | -0.32 / -0.38 | 0/5 ✗ | -0.52 | ✗  stop atr 1.5→1.2: -0.43R | 0 | 0.31R | 36, -0.72 (-0.47 / -1.05) | 109 / 47 of 212 | 0 | not cost-viable: fees + slippage 0.31R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.50; max drawdown 193.9R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 616 | 25.5 | -0.442 | 0.55 | 280.8R | -0.46 / -0.40 | -0.58 / -0.34 | 0/5 ✗ | -0.61 | ✗  n 20→24: -0.47R | 1 | 0.35R | 18, +0.08 (-0.49 / +0.53) | 452 / 1080 of 1715 | 0 | not cost-viable: fees + slippage 0.35R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.55; max drawdown 280.8R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 419 | 26.0 | -1.175 | 0.15 | 495.0R | -1.26 / -1.07 | -1.08 / -1.65 | 0/5 ✗ | -1.86 | ✗  stop atr 1.0→0.8: -1.53R | 0 | 1.08R | 113, -1.17 (-1.34 / -0.99) | 188 / 629 of 936 | 0 | not cost-viable: fees + slippage 1.08R per trade (stop must be ≥ 4x the round-trip cost); avg -1.17R/trade (needs +0.10R); profit factor 0.15; max drawdown 495.0R; not profitable in BOTH train and unseen test |
