...
**Updated:** 2026-09-25 21:20 Beijing time (2026-09-25 13:20 UTC) · data: Binance · 10 coins scanned

> Signals only - not financial advice. Paper-trade first. Never risk money you cannot afford to lose.

**Storage:** repository 1.2 MB (GitHub) · large files of this run 1.6 MB, published to branch `live-reports` (replaced every run, no history)
...
## 0b. Coins this run
- **Signal coins (7/7)** - only these can give signals: **BTC**, **ETH**, **XRP**, **SOL**, **ZEC**, **SUI**, **LTC**
- **Research only** - backtested, never a signal: BNB, UNI, ENA
- **Waiting to join:** BNB (1/2 runs)
- **Outside the top, may leave:** LTC (1/2 runs)
- **Changes this run** (also written to `memory/universe_log.md`):
  - **ELIGIBLE** AVAX - passes every rule again

| Not eligible | 24h volume | Why |
|---|---|---|
| ONDO | $136M | 7-day average volume $43M < $50M; suspended for the rest of the UTC day (moved more than ±25% earlier today); order book too thin: $179k within 1% (need $250k) |
| VTHO | $118M | 7-day average volume $4M < $50M; spread 0.128% > 0.1%; order book too thin: $91k within 1% (need $250k) |
| LINK | $90M | 7-day average volume $44M < $50M |
| SAGA | $84M | 7-day average volume $21M < $50M; suspended for the rest of the UTC day (moved more than ±25% earlier today); order book too thin: $20k within 1% (need $250k) |
| BABY | $66M | 7-day average volume $16M < $50M; order book too thin: $58k within 1% (need $250k) |
| XPL | $66M | 7-day average volume $18M < $50M; 24h move +25.6% is beyond ±25% - suspended for the rest of the UTC day |
...
|---|---|---|---|---|---|---|
| BTC | down (LH/LL) | 84,888 / 83,750.5 | 0.71 | 1.95x | 0.90x | bull_reject, bear_reject |
| ETH | down (LH/LL) | 2,700.21 / 2,667.33 | 0.83 | 2.02x | 0.98x | bull_reject, bear_reject |
| XRP | up (HH/HL) | 1.5612 / 1.5191 | 0.43 | 6.81x | 1.01x | displacement_up, breakout_up |
| SOL | mixed (HH/LL) | 118.44 / 115.86 | 0.83 | 2.51x | 1.10x | bull_reject, breakout_up, retest_up |
| ZEC | mixed (LH/HL) | 1,563.33 / 1,535.17 | 0.97 | 1.54x | 0.97x | bull_engulf, bull_reject, bear_reject, breakout_up, retest_up, failed_breakout_up |
| SUI | up (HH/HL) | 1.0598 / 1.0056 | 0.72 | 3.44x | 1.34x | displacement_up, breakout_up |
| LTC | down (LH/LL) | 71.7 / 69.8 | 0.55 | 1.09x | 1.28x | bear_engulf, bull_reject |
...
| 1h | displacement_up | 609 | 47% | 34% | 26% | 74% | 43% | 29% | can't tell from chance | 0.27R |
| 1h | displacement_down | 433 | 37% | 23% | 14% | 81% | 38% | 25% | can't tell from chance | 0.18R |
| 1h | bull_engulf | 1713 | 40% | 28% | 22% | 75% | 42% | 29% | worse than chance | 0.32R |
...
| 1h | bear_reject | 1343 | 36% | 24% | 17% | 82% | 39% | 25% | worse than chance | 0.18R |
| 1h | smc_sweep_bull | 641 | 40% | 26% | 18% | 78% | 42% | 29% | can't tell from chance | 0.31R |
| 1h | smc_sweep_bear | 705 | 38% | 24% | 16% | 81% | 38% | 25% | can't tell from chance | 0.18R |
| 1h | smc_bos_up | 404 | 43% | 30% | 23% | 78% | 42% | 29% | can't tell from chance | 0.27R |
| 1h | smc_bos_down | 285 | 38% | 27% | 18% | 82% | 40% | 25% | can't tell from chance | 0.21R |
| 1h | smc_choch_up | 113 | 50% | 36% | 30% | 71% | 42% | 29% | can't tell from chance | 0.33R |
| 1h | smc_choch_down | 109 | 46% | 30% | 17% | 72% | 37% | 23% | can't tell from chance | 0.17R |
| 1h | smc_fvg_retrace_bull | 878 | 45% | 32% | 24% | 71% | 43% | 29% | can't tell from chance | 0.30R |
| 1h | smc_fvg_retrace_bear | 807 | 42% | 28% | 19% | 77% | 39% | 25% | can't tell from chance | 0.20R |
| 30m | displacement_up | 642 | 42% | 31% | 26% | 77% | 42% | 29% | can't tell from chance | 0.30R |
| 30m | displacement_down | 416 | 39% | 24% | 14% | 83% | 37% | 22% | can't tell from chance | 0.20R |
| 30m | bull_engulf | 1719 | 40% | 28% | 20% | 76% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | bear_engulf | 1757 | 35% | 21% | 14% | 82% | 36% | 22% | can't tell from chance | 0.22R |
| 30m | bull_reject | 1341 | 44% | 29% | 21% | 74% | 41% | 29% | beats chance | 0.35R |
| 30m | bear_reject | 1399 | 37% | 23% | 15% | 82% | 36% | 21% | can't tell from chance | 0.21R |
| 30m | smc_sweep_bull | 622 | 40% | 27% | 17% | 76% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | smc_sweep_bear | 628 | 41% | 26% | 17% | 83% | 37% | 21% | beats chance | 0.21R |
| 30m | smc_bos_up | 461 | 40% | 33% | 27% | 77% | 41% | 29% | can't tell from chance | 0.32R |
| 30m | smc_bos_down | 236 | 34% | 22% | 13% | 85% | 38% | 21% | can't tell from chance | 0.24R |
| 30m | smc_choch_up | 103 | 36% | 22% | 17% | 83% | 39% | 28% | can't tell from chance | 0.39R |
| 30m | smc_choch_down | 100 | 37% | 22% | 16% | 82% | 36% | 23% | can't tell from chance | 0.19R |
| 30m | smc_fvg_retrace_bull | 978 | 42% | 29% | 22% | 75% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | smc_fvg_retrace_bear | 827 | 38% | 22% | 16% | 81% | 36% | 22% | can't tell from chance | 0.24R |
| 15m | displacement_up | 488 | 36% | 27% | 20% | 82% | 36% | 25% | can't tell from chance | 0.43R |
| 15m | displacement_down | 455 | 34% | 21% | 13% | 85% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | bull_engulf | 1667 | 37% | 27% | 19% | 78% | 35% | 25% | can't tell from chance | 0.51R |
| 15m | bear_engulf | 1614 | 36% | 24% | 15% | 80% | 36% | 22% | can't tell from chance | 0.30R |
| 15m | bull_reject | 1324 | 35% | 23% | 16% | 81% | 35% | 25% | can't tell from chance | 0.52R |
| 15m | bear_reject | 1457 | 35% | 22% | 14% | 82% | 36% | 22% | can't tell from chance | 0.29R |
| 15m | smc_sweep_bull | 592 | 37% | 25% | 20% | 78% | 36% | 25% | can't tell from chance | 0.46R |
| 15m | smc_sweep_bear | 636 | 38% | 25% | 14% | 83% | 36% | 22% | can't tell from chance | 0.29R |
| 15m | smc_bos_up | 349 | 39% | 28% | 22% | 81% | 36% | 26% | can't tell from chance | 0.42R |
| 15m | smc_bos_down | 352 | 34% | 20% | 13% | 86% | 35% | 22% | can't tell from chance | 0.33R |
| 15m | smc_choch_up | 90 | 37% | 26% | 19% | 79% | 35% | 24% | can't tell from chance | 0.46R |
| 15m | smc_choch_down | 86 | 33% | 21% | 14% | 81% | 36% | 22% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 1016 | 33% | 23% | 16% | 81% | 35% | 24% | can't tell from chance | 0.49R |
| 15m | smc_fvg_retrace_bear | 969 | 37% | 25% | 17% | 80% | 36% | 22% | can't tell from chance | 0.31R |
| 5m | displacement_up | 1200 | 32% | 21% | 16% | 84% | 28% | 20% | beats chance | 0.80R |
| 5m | displacement_down | 1122 | 28% | 18% | 12% | 87% | 30% | 20% | can't tell from chance | 0.53R |
| 5m | bull_engulf | 4138 | 27% | 19% | 13% | 83% | 28% | 19% | can't tell from chance | 0.88R |
| 5m | bear_engulf | 4091 | 32% | 21% | 14% | 83% | 30% | 20% | can't tell from chance | 0.54R |
| 5m | bull_reject | 3458 | 27% | 18% | 14% | 81% | 28% | 19% | can't tell from chance | 0.90R |
| 5m | bear_reject | 3702 | 32% | 21% | 14% | 82% | 31% | 21% | can't tell from chance | 0.52R |
| 5m | smc_sweep_bull | 1231 | 31% | 22% | 16% | 79% | 28% | 20% | beats chance | 0.78R |
| 5m | smc_sweep_bear | 1285 | 35% | 24% | 16% | 81% | 32% | 21% | can't tell from chance | 0.45R |
| 5m | smc_bos_up | 815 | 30% | 21% | 17% | 84% | 29% | 20% | can't tell from chance | 0.82R |
| 5m | smc_bos_down | 895 | 28% | 19% | 12% | 86% | 31% | 21% | can't tell from chance | 0.57R |
| 5m | smc_choch_up | 216 | 37% | 25% | 17% | 86% | 28% | 19% | beats chance | 0.90R |
| 5m | smc_choch_down | 213 | 26% | 16% | 12% | 87% | 32% | 21% | can't tell from chance | 0.52R |
| 5m | smc_fvg_retrace_bull | 3264 | 29% | 19% | 14% | 81% | 27% | 19% | can't tell from chance | 0.89R |
| 5m | smc_fvg_retrace_bear | 2975 | 28% | 19% | 12% | 84% | 31% | 20% | worse than chance | 0.55R |
...
|---|---|---|---|---|---|
| **BTC** | TRANSITION (weak) | WEAK_BULL (moderate) | TRANSITION (weak) | RANGE (weak) | NO TRADE (timeframes disagree (1D WEAK_BULL, 4H TRANSITION, 1H RANGE)) |
...
| **LTC** | TRANSITION (weak) | EXPANSION up (weak) | WEAK_BULL (weak) | UNCLEAR (weak) | LONG allowed (1D/4H bullish, 1W TRANSITION) |
...
| **UNI** | EXPANSION up (weak) | EXPANSION up (strong) | TRANSITION (weak) | RANGE (weak) | NO TRADE (timeframes disagree (1D EXPANSION, 4H TRANSITION, 1H RANGE)) |
| **ENA** | TRANSITION (weak) | WEAK_BULL (weak) | WEAK_BULL (weak) | WEAK_BULL (moderate) | LONG allowed (1D/4H/1H bullish, 1W TRANSITION) |
...
- **1H RANGE (weak)** - for: EMA-fast flat (-0.1 ATR in 10 candles); ADX 16 = weak trend / ranging; candle size 0.90x normal, Bollinger width above 1% of the last 100 candles · against: close above EMA-fast above EMA-slow; swing structure down (LH/LL)
...
|---|---|---|---|---|---|---|---|
| **BTC** | up (CHOCH 8 candles ago) | sell-side (bullish idea) 28 candles ago | bear 84,744.74-84,841.04 | bear 86,133.40-86,975.51 | premium (63%) | swing high 87,278.54 (5.6 ATR) | swing low 83,750.50 (1.44 ATR) |
| **ETH** | up (BOS 8 candles ago) | sell-side (bullish idea) 3 candles ago | bull 2,680.32-2,686.46 (retraced) | bear 2,745.99-2,784.40 | above the range (153%) | swing high 2,789.00 (3.25 ATR) | swing low 2,667.33 (2.3 ATR) |
| **XRP** | up (CHOCH 4 candles ago) | buy-side (bearish idea) 8 candles ago | bear 1.6015-1.6117 | bull 1.3773-1.3856 | above the range (194%) | swing high 1.6581 (2.49 ATR) | swing low 1.5191 (3.56 ATR) |
| **SOL** | up (BOS 19 candles ago) | buy-side (bearish idea) 9 candles ago | bull 118.38-118.67 (retraced) | bull 115.86-117.34 | above the range (189%) | - | swing low 115.86 (3.62 ATR) |
| **ZEC** | up (BOS 10 candles ago) | buy-side (bearish idea) 0 candles ago | bull 1,590.83-1,600.22 | bull 1,098.88-1,133.82 | above the range (253%) | swing high 1,679.83 (2.69 ATR) | swing low 1,535.17 (2.61 ATR) |
| **SUI** | up (BOS 19 candles ago) | sell-side (bullish idea) 22 candles ago | bull 1.0977-1.1269 (retraced) | bull 1.0050-1.0598 | above the range (260%) | - | swing low 1.0056 (5.24 ATR) |
| **LTC** | up (BOS 62 candles ago) | sell-side (bullish idea) 3 candles ago | bear 70.600-70.740 (retraced) | bull 58.800-63.080 | discount (15%) | swing high 71.700 (1.19 ATR) | swing low 65.520 (3.39 ATR) |
...
| bb_squeeze_breakout | 1.0 | 1h | **FAILED** | 871 | 51.0 | -0.051 | 0.91 | 65.5R | -0.06 / -0.04 | -0.09 / -0.01 | 0/5 ✗ | -0.14 | ✗  stop atr 1.5→1.2: -0.09R | 3 | 0.14R | 4, -0.44 (-1.18 / +0.29) | 132 / 46 of 212 | 0 | avg -0.05R/trade (needs +0.10R); profit factor 0.91; max drawdown 65.5R; not profitable in BOTH train and unseen test |
...
| donchian_breakout | 1.0 | 30m | **FAILED** | 1282 | 48.7 | -0.080 | 0.85 | 130.7R | -0.09 / -0.05 | -0.05 / -0.11 | 1/5 ✗ | -0.15 | ✗  stop atr 2.0→1.6: -0.15R | 2 | 0.13R | 47, -0.05 (-0.06 / -0.04) | 137 / 64 of 450 | 0 | avg -0.08R/trade (needs +0.10R); profit factor 0.85; max drawdown 130.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7315 | 54.0 | -0.125 | 0.55 | 916.8R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 38, -0.17 (-0.27 / +0.00) | 1006 / 6 of 1361 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.55; max drawdown 916.8R; not profitable in BOTH train and unseen test |
...
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 1h | **FAILED** | 868 | 32.3 | -0.176 | 0.78 | 182.4R | -0.13 / -0.26 | -0.22 / -0.14 | 1/5 ✗ | -0.28 | ✗  stop buffer_atr 0.2→0.16: -0.22R | 1 | 0.21R | 10, -0.18 (+0.55 / -1.27) | 478 / 1191 of 1749 | 0 | avg -0.18R/trade (needs +0.10R); profit factor 0.78; max drawdown 182.4R; not profitable in BOTH train and unseen test |
...
| ema_9_21_cross | 1.0 | 15m | **FAILED** | 449 | 44.3 | -0.195 | 0.68 | 94.2R | -0.21 / -0.15 | -0.26 / -0.16 | 1/5 ✗ | -0.35 | ✗  stop atr 1.5→1.2: -0.30R | 1 | 0.27R | 21, +0.00 (+0.14 / -0.34) | 62 / 18 of 105 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.19R/trade (needs +0.10R); profit factor 0.68; max drawdown 94.2R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 30m | **FAILED** | 2795 | 45.9 | -0.211 | 0.37 | 592.4R | -0.19 / -0.25 | -0.25 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 2.0→1.6: -0.27R | 0 | 0.18R | 33, -0.12 (-0.20 / +0.17) | 1048 / 25 of 1260 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.37; max drawdown 592.4R; not profitable in BOTH train and unseen test |
| S6-OB-FVG-noSMC | 1.0 | 15m | **FAILED** | 37 | 35.1 | -0.212 | 0.69 | 11.1R | +0.05 / -0.59 | -0.46 / -0.00 | 1/5 ✗ | -0.32 | ✗  time_stop_bars 30→24: -0.26R | 2 | 0.16R | 6, -0.26 (+0.17 / -0.48) | 107 / 33 of 154 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.69; max drawdown 11.1R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 1h | **FAILED** | 329 | 47.4 | -0.221 | 0.64 | 73.6R | -0.23 / -0.21 | -0.24 / -0.19 | 0/5 ✗ | -0.32 | ✗  vol_x 1.2→1.44: -0.33R | 2 | 0.17R | 5, -0.41 (-0.36 / -0.48) | 105 / 220 of 333 | 0 | avg -0.22R/trade (needs +0.10R); profit factor 0.64; max drawdown 73.6R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2143 | 32.7 | -0.356 | 0.19 | 763.4R | -0.35 / -0.38 | -0.44 / -0.28 | 0/5 ✗ | -0.53 | ✗  hi 90→108: -0.44R | 0 | 0.30R | 57, -0.27 (-0.29 / -0.17) | 1186 / 34 of 1359 | 0 | not cost-viable: fees + slippage 0.30R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.19; max drawdown 763.4R; not profitable in BOTH train and unseen test |
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 540 | 41.9 | -0.357 | 0.5 | 193.9R | -0.35 / -0.37 | -0.32 / -0.38 | 0/5 ✗ | -0.52 | ✗  stop atr 1.5→1.2: -0.43R | 0 | 0.31R | 37, -0.65 (-0.44 / -0.97) | 114 / 50 of 221 | 0 | not cost-viable: fees + slippage 0.31R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.50; max drawdown 193.9R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 616 | 25.5 | -0.442 | 0.55 | 280.8R | -0.46 / -0.40 | -0.58 / -0.34 | 0/5 ✗ | -0.61 | ✗  n 20→24: -0.47R | 1 | 0.35R | 18, +0.08 (+0.34 / -0.18) | 451 / 1093 of 1731 | 0 | not cost-viable: fees + slippage 0.35R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.55; max drawdown 280.8R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 30m | **FAILED** | 329 | 39.2 | -0.444 | 0.4 | 146.5R | -0.41 / -0.54 | -0.44 / -0.45 | 0/5 ✗ | -0.60 | ✗  stop atr 1.0→0.8: -0.48R | 0 | 0.29R | 13, -0.50 (-0.33 / -0.69) | 114 / 219 of 358 | 0 | not cost-viable: fees + slippage 0.29R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.40; max drawdown 146.5R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 15m | **FAILED** | 567 | 38.6 | -0.507 | 0.37 | 289.3R | -0.50 / -0.52 | -0.59 / -0.47 | 0/5 ✗ | -0.72 | ✗  stop atr 1.0→0.8: -0.55R | 0 | 0.39R | 27, -0.52 (-0.65 / -0.41) | 102 / 240 of 374 | 0 | not cost-viable: fees + slippage 0.39R per trade (stop must be ≥ 4x the round-trip cost); avg -0.51R/trade (needs +0.10R); profit factor 0.37; max drawdown 289.3R; not profitable in BOTH train and unseen test |
...
| `memory/changelog.md` | 62.0 KB | - | - |
| `memory/coin_notes.md` | 0.6 KB | - | - |
| `memory/execution_notes.md` | 2.2 KB | 4 | 2026-09-25 11:18 UTC |
