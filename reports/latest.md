...
**Updated:** 2026-09-27 05:17 Beijing time (2026-09-26 21:17 UTC) · data: Binance · 8 coins scanned

> Signals only - not financial advice. Paper-trade first. Never risk money you cannot afford to lose.

**Storage:** repository 6.1 MB (GitHub) · large files of this run 2.4 MB, published to branch `live-reports` (replaced every run, no history)

```
POSITION BOOK — 2026-09-26 21:17 UTC / 2026-09-27 05:17 Beijing
...
Checked 2026-09-26 21:17 UTC. History is saved every hour from now on (exchanges keep only ~30 days).

Every building block reads ONE series, the main source (OKX), in backtests and live; Binance is kept as a separate research series and never mixed in (their levels differ).

| Coin | State | Main source | Main history | Funding now | Long/short | Taker buy/sell | Problems |
|---|---|---|---|---|---|---|---|
| BTC | GOOD | okx | 751 h since 2026-08-26 | -0.0006% | 1.34 | 1.15 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=BTCUSDT&period=1h&limit=500 |
| ETH | GOOD | okx | 751 h since 2026-08-26 | +0.0018% | 1.37 | 0.63 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ETHUSDT&period=1h&limit=500 |
| SOL | GOOD | okx | 751 h since 2026-08-26 | +0.0066% | 1.44 | 0.69 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SOLUSDT&period=1h&limit=500 |
| XRP | GOOD | okx | 751 h since 2026-08-26 | +0.0100% | 2.54 | 0.69 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=XRPUSDT&period=1h&limit=500 |
| ZEC | GOOD | okx | 751 h since 2026-08-26 | +0.0022% | 0.51 | 0.96 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ZECUSDT&period=1h&limit=500 |
| SUI | GOOD | okx | 751 h since 2026-08-26 | +0.0087% | 1.86 | 0.47 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SUIUSDT&period=1h&limit=500 |
| ENA | GOOD | okx | 751 h since 2026-08-26 | +0.0050% | 0.99 | 0.47 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ENAUSDT&period=1h&limit=500 |
| UNI | GOOD | okx | 751 h since 2026-08-26 | +0.0100% | 1.82 | 0.67 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=UNIUSDT&period=1h&limit=500 |
...
|---|---|---|---|---|---|---|
| BTC | up (HH/HL) | 84,337 / 83,856.2 | 0.74 | 0.71x | 0.45x | bear_engulf, bull_reject |
| ETH | mixed (LH/HL) | 2,696 / 2,682 | 0.58 | 2.54x | 0.49x | breakout_down |
| SOL | down (LH/LL) | 122.1 / 119.82 | 0.19 | 1.08x | 0.85x | bear_engulf |
| XRP | mixed (LH/HL) | 1.5541 / 1.5371 | 0.43 | 2.00x | 0.61x | bear_engulf, breakout_down, retest_down |
| ZEC | down (LH/LL) | 1,540.22 / 1,517.41 | 0.89 | 1.38x | 0.65x | bull_engulf, bear_reject |
| SUI | mixed (LH/HL) | 1.1866 / 1.155 | 0.40 | 1.50x | 0.97x | bear_engulf, breakout_down |
| ENA | up (HH/HL) | 0.2857 / 0.2632 | 0.33 | 0.62x | 1.06x | bear_engulf, bear_reject |
...
| 1h | bull_engulf | 1377 | 40% | 28% | 22% | 75% | 43% | 30% | can't tell from chance | 0.29R |
| 1h | bear_engulf | 1469 | 40% | 25% | 17% | 79% | 39% | 25% | can't tell from chance | 0.18R |
| 1h | bull_reject | 1127 | 41% | 29% | 22% | 75% | 43% | 30% | can't tell from chance | 0.28R |
...
| 1h | smc_bos_up | 326 | 44% | 31% | 25% | 78% | 44% | 31% | can't tell from chance | 0.22R |
| 1h | smc_bos_down | 224 | 37% | 27% | 19% | 83% | 38% | 25% | can't tell from chance | 0.20R |
| 1h | smc_choch_up | 100 | 49% | 38% | 32% | 70% | 46% | 32% | can't tell from chance | 0.31R |
| 1h | smc_choch_down | 96 | 47% | 30% | 17% | 74% | 36% | 22% | beats chance | 0.16R |
| 1h | smc_fvg_retrace_bull | 705 | 45% | 33% | 26% | 71% | 43% | 29% | can't tell from chance | 0.26R |
| 1h | smc_fvg_retrace_bear | 650 | 42% | 29% | 20% | 78% | 39% | 25% | can't tell from chance | 0.18R |
| 30m | displacement_up | 519 | 43% | 32% | 26% | 76% | 44% | 31% | can't tell from chance | 0.26R |
| 30m | displacement_down | 331 | 42% | 25% | 14% | 82% | 37% | 21% | can't tell from chance | 0.16R |
| 30m | bull_engulf | 1405 | 42% | 29% | 22% | 75% | 43% | 30% | can't tell from chance | 0.31R |
| 30m | bear_engulf | 1398 | 37% | 21% | 14% | 82% | 37% | 21% | can't tell from chance | 0.18R |
...
| 30m | smc_bos_up | 390 | 43% | 33% | 28% | 76% | 43% | 31% | can't tell from chance | 0.28R |
| 30m | smc_bos_down | 179 | 36% | 21% | 11% | 85% | 37% | 22% | can't tell from chance | 0.21R |
| 30m | smc_choch_up | 82 | 39% | 23% | 18% | 83% | 42% | 31% | can't tell from chance | 0.32R |
| 30m | smc_choch_down | 81 | 42% | 23% | 17% | 80% | 36% | 21% | can't tell from chance | 0.14R |
| 30m | smc_fvg_retrace_bull | 773 | 44% | 30% | 23% | 73% | 43% | 31% | can't tell from chance | 0.28R |
| 30m | smc_fvg_retrace_bear | 624 | 38% | 22% | 16% | 82% | 36% | 21% | can't tell from chance | 0.20R |
| 15m | displacement_up | 364 | 37% | 27% | 20% | 82% | 38% | 26% | can't tell from chance | 0.34R |
| 15m | displacement_down | 367 | 35% | 20% | 13% | 85% | 38% | 24% | can't tell from chance | 0.25R |
| 15m | bull_engulf | 1312 | 38% | 27% | 19% | 78% | 36% | 25% | can't tell from chance | 0.44R |
| 15m | bear_engulf | 1286 | 36% | 24% | 15% | 79% | 36% | 23% | can't tell from chance | 0.25R |
| 15m | bull_reject | 1058 | 35% | 23% | 15% | 80% | 36% | 25% | can't tell from chance | 0.44R |
| 15m | bear_reject | 1124 | 35% | 22% | 15% | 81% | 37% | 23% | can't tell from chance | 0.25R |
| 15m | smc_sweep_bull | 478 | 37% | 25% | 20% | 78% | 36% | 25% | can't tell from chance | 0.41R |
| 15m | smc_sweep_bear | 519 | 39% | 26% | 14% | 82% | 36% | 22% | can't tell from chance | 0.24R |
| 15m | smc_bos_up | 271 | 40% | 30% | 22% | 80% | 37% | 26% | can't tell from chance | 0.32R |
| 15m | smc_bos_down | 300 | 32% | 18% | 12% | 86% | 36% | 22% | can't tell from chance | 0.30R |
| 15m | smc_choch_up | 74 | 31% | 24% | 18% | 82% | 34% | 23% | can't tell from chance | 0.41R |
| 15m | smc_choch_down | 71 | 37% | 23% | 14% | 80% | 37% | 24% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 802 | 34% | 25% | 16% | 81% | 36% | 25% | can't tell from chance | 0.42R |
| 15m | smc_fvg_retrace_bear | 762 | 38% | 26% | 18% | 79% | 36% | 23% | can't tell from chance | 0.26R |
| 5m | displacement_up | 962 | 32% | 21% | 16% | 84% | 30% | 20% | can't tell from chance | 0.68R |
| 5m | displacement_down | 919 | 28% | 17% | 12% | 87% | 31% | 21% | worse than chance | 0.45R |
| 5m | bull_engulf | 3353 | 27% | 18% | 13% | 83% | 29% | 20% | worse than chance | 0.77R |
| 5m | bear_engulf | 3312 | 32% | 22% | 14% | 82% | 32% | 21% | can't tell from chance | 0.48R |
| 5m | bull_reject | 2757 | 27% | 18% | 13% | 82% | 28% | 19% | can't tell from chance | 0.81R |
| 5m | bear_reject | 2997 | 33% | 22% | 15% | 81% | 32% | 21% | can't tell from chance | 0.45R |
| 5m | smc_sweep_bull | 977 | 30% | 21% | 15% | 79% | 30% | 21% | can't tell from chance | 0.70R |
| 5m | smc_sweep_bear | 1028 | 35% | 25% | 17% | 81% | 33% | 22% | can't tell from chance | 0.39R |
| 5m | smc_bos_up | 621 | 31% | 22% | 18% | 85% | 29% | 20% | can't tell from chance | 0.66R |
| 5m | smc_bos_down | 734 | 29% | 20% | 12% | 86% | 31% | 21% | can't tell from chance | 0.52R |
| 5m | smc_choch_up | 177 | 36% | 27% | 18% | 85% | 27% | 19% | beats chance | 0.80R |
| 5m | smc_choch_down | 177 | 25% | 14% | 10% | 88% | 31% | 19% | can't tell from chance | 0.45R |
...
| **UNI** | EXPANSION up (weak) | STRONG_BULL (moderate) | TRANSITION (weak) | COMPRESSION (strong) | NO TRADE (timeframes disagree (1D STRONG_BULL, 4H TRANSITION, 1H COMPRESSION)) |
...
- **1H COMPRESSION (moderate)** - for: EMAs not lined up; EMA-fast flat (-0.2 ATR in 10 candles); ADX 15 = weak trend / ranging; candle size 0.45x normal, Bollinger width above 0% of the last 100 candles · against: swing structure up (HH/HL)
...
|---|---|---|---|---|---|---|---|
| **BTC** | up (BOS 50 candles ago) | sell-side (bullish idea) 32 candles ago | bear 84,038.01-84,208.06 (retraced) | bear 86,133.40-86,975.51 | discount (36%) | swing high 84,336.96 (1.37 ATR) | equal lows 83,848.91 (0.81 ATR) |
| **ETH** | down (BOS 10 candles ago) | sell-side (bullish idea) 1 candles ago | bear 2,677.24-2,681.97 (retraced) | bear 2,745.99-2,784.40 | below the range (-37%) | swing high 2,696.00 (1.9 ATR) | swing low 2,600.15 (7.61 ATR) |
| **SOL** | down (CHOCH 2 candles ago) | sell-side (bullish idea) 1 candles ago | bear 120.73-120.91 (retraced) | bull 115.86-117.34 | discount (23%) | swing high 122.10 (1.8 ATR) | swing low 119.82 (0.54 ATR) |
| **XRP** | down (BOS 2 candles ago) | sell-side (bullish idea) 4 candles ago | bear 1.5139-1.5192 (retraced) | bull 1.3773-1.3856 | below the range (-149%) | swing high 1.5541 (3.02 ATR) | swing low 1.4517 (4.28 ATR) |
| **ZEC** | down (BOS 48 candles ago) | buy-side (bearish idea) 2 candles ago | bull 1,542.93-1,545.92 | bull 1,098.88-1,133.82 | above the range (284%) | swing high 1,625.00 (2.34 ATR) | swing low 1,517.41 (3.55 ATR) |
| **SUI** | down (CHOCH 2 candles ago) | sell-side (bullish idea) 4 candles ago | bear 1.1444-1.1540 (retraced) | bull 1.0050-1.0598 | below the range (-37%) | swing high 1.1866 (2.24 ATR) | swing low 1.0901 (2.77 ATR) |
| **ENA** | up (BOS 43 candles ago) | sell-side (bullish idea) 18 candles ago | bear 0.26960-0.27040 | bull 0.16130-0.17050 | discount (24%) | swing high 0.28570 (2.75 ATR) | swing low 0.26320 (0.87 ATR) |
...
| R4-BBRSI 🧪 lab | 1.0 | 30m | **FORMALIZED** | - | - | - | - | - | - / - | - / - | - | - | - | - | - | - | 27, -0.26 (-0.48 / +0.25) | 508 / 12 of 591 | 0 | waiting for the first daily research run (Layers B/C) |
...
| donchian_breakout-VEXIT 🧪 lab | 1.0 | 30m | **FORMALIZED** | - | - | - | - | - | - / - | - / - | - | - | - | - | - | - | 42, +0.06 (+0.28 / -0.50) | 106 / 29 of 312 | 0 | waiting for the first daily research run (Layers B/C) |
...
| bb_squeeze_breakout | 1.0 | 1h | **FAILED** | 832 | 53.4 | -0.010 | 0.98 | 38.5R | -0.01 / +0.00 | -0.07 / +0.04 | 2/5 ✗ | -0.09 | - | ✗  bb_k 2→1: -0.05R | 4 | 0.14R | 2, +1.05 (+0.00 / +1.05) | 110 / 33 of 175 | 0 | avg -0.01R/trade (needs +0.10R); profit factor 0.98; max drawdown 38.5R; not profitable in BOTH train and unseen test |
...
| donchian_breakout | 1.0 | 30m | **FAILED** | 1329 | 48.5 | -0.067 | 0.88 | 114.7R | -0.08 / -0.04 | -0.03 / -0.11 | 1/5 ✗ | -0.14 | - | ✗  stop atr 2.0→1.6: -0.14R | 3 | 0.12R | 42, +0.01 (+0.14 / -0.30) | 106 / 29 of 312 | 0 | avg -0.07R/trade (needs +0.10R); profit factor 0.88; max drawdown 114.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 6989 | 53.6 | -0.129 | 0.54 | 906.7R | -0.11 / -0.17 | -0.14 / -0.12 | 0/5 ✗ | -0.19 | - | ✗  stop atr 2.0→1.6: -0.16R | 0 | 0.11R | 35, -0.15 (-0.31 / +0.09) | 834 / 1 of 1124 | 0 | avg -0.13R/trade (needs +0.10R); profit factor 0.54; max drawdown 906.7R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6338 | 47.2 | -0.138 | 0.76 | 900.0R | -0.14 / -0.13 | -0.18 / -0.10 | 0/5 ✗ | -0.21 | - | ✗  stop atr 1.5→1.2: -0.18R | 1 | 0.13R | 39, -0.02 (-0.09 / +0.09) | 917 / 217 of 1453 | 0 | avg -0.14R/trade (needs +0.10R); profit factor 0.76; max drawdown 900.0R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 30m | **FAILED** | 3534 | 46.3 | -0.190 | 0.69 | 692.8R | -0.18 / -0.22 | -0.22 / -0.16 | 0/5 ✗ | -0.30 | - | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.17R | 69, +0.20 (+0.54 / -0.26) | 666 / 166 of 1349 | 0 | avg -0.19R/trade (needs +0.10R); profit factor 0.69; max drawdown 692.8R; not profitable in BOTH train and unseen test |
...
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 1h | **FAILED** | 795 | 30.7 | -0.214 | 0.74 | 206.8R | -0.20 / -0.24 | -0.26 / -0.17 | 0/5 ✗ | -0.32 | - | ✗  stop buffer_atr 0.2→0.16: -0.25R | 1 | 0.21R | 8, +0.09 (+0.37 / -0.20) | 381 / 923 of 1379 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.74; max drawdown 206.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 15m | **FAILED** | 3140 | 45.1 | -0.251 | 0.62 | 793.3R | -0.24 / -0.28 | -0.29 / -0.23 | 0/5 ✗ | -0.40 | - | ✗  stop atr 1.5→1.2: -0.33R | 0 | 0.25R | 142, -0.05 (+0.10 / -0.35) | 1021 / 258 of 1807 | 0 | not cost-viable: fees + slippage 0.25R per trade (stop must be ≥ 4x the round-trip cost); avg -0.25R/trade (needs +0.10R); profit factor 0.62; max drawdown 793.3R; not profitable in BOTH train and unseen test |
...
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 605 | 26.0 | -0.424 | 0.56 | 265.0R | -0.41 / -0.45 | -0.55 / -0.32 | 1/5 ✗ | -0.60 | - | ✗  n 20→24: -0.49R | 2 | 0.32R | 15, +0.13 (+0.45 / -0.24) | 370 / 801 of 1335 | 0 | not cost-viable: fees + slippage 0.32R per trade (stop must be ≥ 4x the round-trip cost); avg -0.42R/trade (needs +0.10R); profit factor 0.56; max drawdown 265.0R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 15m | **FAILED** | 582 | 39.5 | -0.466 | 0.4 | 272.9R | -0.44 / -0.55 | -0.61 / -0.40 | 0/5 ✗ | -0.67 | - | ✗  stop atr 1.0→0.8: -0.54R | 0 | 0.37R | 22, -0.47 (-0.73 / -0.25) | 77 / 192 of 295 | 0 | not cost-viable: fees + slippage 0.37R per trade (stop must be ≥ 4x the round-trip cost); avg -0.47R/trade (needs +0.10R); profit factor 0.40; max drawdown 272.9R; not profitable in BOTH train and unseen test |
...
| ema_9_21_cross | 1.0 | 5m | **FAILED** | 276 | 29.7 | -0.716 | 0.25 | 197.6R | -0.78 / -0.61 | -0.68 / -0.86 | 0/5 ✗ | -1.08 | - | ✗  stop atr 1.5→1.2: -0.90R | 0 | 0.55R | 53, -0.48 (-0.30 / -0.70) | 166 / 54 of 276 | 0 | not cost-viable: fees + slippage 0.55R per trade (stop must be ≥ 4x the round-trip cost); avg -0.72R/trade (needs +0.10R); profit factor 0.25; max drawdown 197.6R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 423 | 26.5 | -1.137 | 0.16 | 484.2R | -1.18 / -1.09 | -1.05 / -1.66 | 0/5 ✗ | -1.79 | - | ✗  stop atr 1.0→0.8: -1.47R | 0 | 1.02R | 98, -1.25 (-1.48 / -0.96) | 161 / 507 of 772 | 0 | not cost-viable: fees + slippage 1.02R per trade (stop must be ≥ 4x the round-trip cost); avg -1.14R/trade (needs +0.10R); profit factor 0.16; max drawdown 484.2R; not profitable in BOTH train and unseen test |
...
| `memory/smc_events.csv` | 115.0 KB | - | - |
