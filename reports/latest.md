...
**Updated:** 2026-09-25 18:18 Beijing time (2026-09-25 10:18 UTC) · data: Binance · 10 coins scanned
...
```
POSITION BOOK — 2026-09-25 10:18 UTC / 2026-09-25 18:18 Beijing
...
## 0b. Coins this run
- **Signal coins (7/7)** - only these can give signals: **BTC**, **ETH**, **SOL**, **ZEC**, **XRP**, **LTC**, **BNB**
- **Research only** - backtested, never a signal: SUI, ENA, UNI
...
|---|---|---|
| ONDO | $153M | 7-day average volume $43M < $50M; 24h move +31.0% is beyond ±25% - suspended for the rest of the UTC day; order book too thin: $158k within 1% (need $250k) |
| SAGA | $79M | 7-day average volume $21M < $50M; suspended for the rest of the UTC day (moved more than ±25% earlier today); order book too thin: $19k within 1% (need $250k) |
| LINK | $75M | 7-day average volume $44M < $50M |
| XPL | $59M | 7-day average volume $18M < $50M; 24h move +29.9% is beyond ±25% - suspended for the rest of the UTC day; order book too thin: $133k within 1% (need $250k) |
| VTHO | $58M | 7-day average volume $4M < $50M; spread 0.133% > 0.1%; order book too thin: $76k within 1% (need $250k) |
...
|---|---|---|---|---|---|---|
| BTC | mixed (LH/HL) | 84,888 / 83,948.4 | 0.34 | 0.96x | 0.82x | bull_reject |
| ETH | mixed (LH/HL) | 2,700.21 / 2,676.03 | 0.51 | 1.52x | 0.87x | - |
| SOL | up (HH/HL) | 118.44 / 116.12 | 0.67 | 2.04x | 0.87x | displacement_up |
| ZEC | mixed (LH/HL) | 1,563.33 / 1,533.12 | 0.36 | 1.10x | 0.90x | breakout_up, retest_up |
| XRP | mixed (HH/LL) | 1.5612 / 1.4517 | 0.58 | 1.19x | 0.85x | - |
| LTC | down (LH/LL) | 72.29 / 69.97 | 0.38 | 0.42x | 1.34x | bear_engulf, bull_reject |
| BNB | down (LH/LL) | 780.08 / 771 | 0.36 | 1.29x | 0.73x | bull_reject |
...
| 1h | displacement_down | 435 | 37% | 23% | 14% | 81% | 37% | 23% | can't tell from chance | 0.18R |
...
| 1h | smc_sweep_bear | 701 | 37% | 24% | 16% | 81% | 39% | 24% | can't tell from chance | 0.19R |
...
| 1h | smc_choch_down | 111 | 46% | 30% | 16% | 73% | 36% | 24% | beats chance | 0.17R |
| 1h | smc_fvg_retrace_bull | 884 | 45% | 32% | 24% | 72% | 42% | 29% | can't tell from chance | 0.30R |
...
| 30m | displacement_down | 416 | 39% | 24% | 14% | 83% | 35% | 21% | can't tell from chance | 0.20R |
| 30m | bull_engulf | 1723 | 40% | 28% | 20% | 76% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | bear_engulf | 1753 | 35% | 21% | 14% | 82% | 36% | 21% | can't tell from chance | 0.22R |
| 30m | bull_reject | 1344 | 44% | 29% | 21% | 73% | 41% | 29% | beats chance | 0.35R |
| 30m | bear_reject | 1402 | 37% | 23% | 15% | 81% | 36% | 22% | can't tell from chance | 0.21R |
| 30m | smc_sweep_bull | 620 | 40% | 26% | 17% | 76% | 41% | 29% | can't tell from chance | 0.36R |
| 30m | smc_sweep_bear | 628 | 41% | 26% | 17% | 83% | 36% | 21% | beats chance | 0.21R |
| 30m | smc_bos_up | 466 | 40% | 32% | 27% | 77% | 41% | 29% | can't tell from chance | 0.33R |
| 30m | smc_bos_down | 231 | 34% | 23% | 13% | 85% | 38% | 23% | can't tell from chance | 0.24R |
| 30m | smc_choch_up | 102 | 35% | 23% | 17% | 83% | 42% | 29% | can't tell from chance | 0.38R |
| 30m | smc_choch_down | 101 | 37% | 22% | 16% | 82% | 39% | 23% | can't tell from chance | 0.19R |
| 30m | smc_fvg_retrace_bull | 982 | 42% | 29% | 22% | 75% | 40% | 28% | can't tell from chance | 0.36R |
| 30m | smc_fvg_retrace_bear | 825 | 38% | 22% | 16% | 81% | 35% | 21% | can't tell from chance | 0.24R |
| 15m | displacement_up | 488 | 36% | 27% | 20% | 82% | 35% | 25% | can't tell from chance | 0.43R |
| 15m | displacement_down | 454 | 34% | 21% | 13% | 85% | 36% | 22% | can't tell from chance | 0.29R |
| 15m | bull_engulf | 1673 | 37% | 27% | 19% | 78% | 35% | 25% | can't tell from chance | 0.51R |
| 15m | bear_engulf | 1609 | 36% | 24% | 15% | 79% | 36% | 22% | can't tell from chance | 0.30R |
| 15m | bull_reject | 1324 | 35% | 23% | 16% | 80% | 35% | 25% | can't tell from chance | 0.52R |
| 15m | bear_reject | 1469 | 35% | 22% | 14% | 82% | 36% | 22% | can't tell from chance | 0.29R |
| 15m | smc_sweep_bull | 588 | 37% | 25% | 20% | 78% | 36% | 25% | can't tell from chance | 0.47R |
| 15m | smc_sweep_bear | 636 | 38% | 25% | 14% | 83% | 36% | 22% | can't tell from chance | 0.29R |
| 15m | smc_bos_up | 358 | 39% | 28% | 23% | 80% | 37% | 26% | can't tell from chance | 0.43R |
| 15m | smc_bos_down | 345 | 34% | 20% | 14% | 85% | 36% | 23% | can't tell from chance | 0.33R |
| 15m | smc_choch_up | 87 | 37% | 25% | 18% | 79% | 33% | 23% | can't tell from chance | 0.44R |
| 15m | smc_choch_down | 85 | 33% | 21% | 14% | 81% | 37% | 25% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 1014 | 34% | 23% | 16% | 80% | 35% | 25% | can't tell from chance | 0.49R |
| 15m | smc_fvg_retrace_bear | 963 | 37% | 25% | 17% | 80% | 36% | 22% | can't tell from chance | 0.31R |
| 5m | displacement_up | 1192 | 31% | 21% | 16% | 84% | 28% | 19% | beats chance | 0.80R |
| 5m | displacement_down | 1128 | 28% | 18% | 12% | 87% | 31% | 20% | worse than chance | 0.53R |
| 5m | bull_engulf | 4136 | 26% | 18% | 13% | 83% | 27% | 19% | can't tell from chance | 0.88R |
| 5m | bear_engulf | 4106 | 32% | 21% | 14% | 83% | 31% | 21% | can't tell from chance | 0.54R |
| 5m | bull_reject | 3461 | 27% | 18% | 13% | 82% | 28% | 19% | can't tell from chance | 0.90R |
| 5m | bear_reject | 3695 | 32% | 21% | 15% | 82% | 32% | 21% | can't tell from chance | 0.52R |
| 5m | smc_sweep_bull | 1239 | 32% | 22% | 16% | 79% | 28% | 19% | beats chance | 0.78R |
| 5m | smc_sweep_bear | 1282 | 35% | 24% | 17% | 81% | 33% | 21% | can't tell from chance | 0.45R |
| 5m | smc_bos_up | 819 | 29% | 21% | 16% | 84% | 28% | 19% | can't tell from chance | 0.83R |
| 5m | smc_bos_down | 887 | 28% | 19% | 11% | 86% | 31% | 21% | can't tell from chance | 0.57R |
| 5m | smc_choch_up | 210 | 37% | 24% | 16% | 86% | 27% | 19% | beats chance | 0.87R |
| 5m | smc_choch_down | 214 | 26% | 16% | 12% | 87% | 31% | 21% | can't tell from chance | 0.53R |
| 5m | smc_fvg_retrace_bull | 3238 | 28% | 19% | 13% | 82% | 27% | 19% | can't tell from chance | 0.89R |
| 5m | smc_fvg_retrace_bear | 2956 | 28% | 19% | 12% | 84% | 31% | 21% | worse than chance | 0.55R |
...
- **1H RANGE (moderate)** - for: EMA-fast flat (-0.1 ATR in 10 candles); swing structure mixed; ADX 16 = weak trend / ranging; candle size 0.82x normal, Bollinger width above 2% of the last 100 candles · against: close above EMA-fast above EMA-slow
...
|---|---|---|---|---|---|---|---|
| **BTC** | down (BOS 14 candles ago) | sell-side (bullish idea) 16 candles ago | bull 84,191.58-84,322.49 (retraced) | bear 86,133.40-86,975.51 | premium (66%) | equal highs 84,942.45 (0.81 ATR) | swing low 82,874.93 (3.68 ATR) |
| **ETH** | up (CHOCH 7 candles ago) | sell-side (bullish idea) 16 candles ago | bull 2,680.32-2,686.46 (retraced) | bear 2,745.99-2,784.40 | above the range (119%) | swing high 2,789.00 (4.31 ATR) | swing low 2,600.15 (5.35 ATR) |
| **SOL** | up (BOS 7 candles ago) | buy-side (bearish idea) 2 candles ago | bull 117.80-117.95 (retraced) | bear 117.85-119.66 | premium (97%) | swing high 119.77 (1.32 ATR) | swing low 112.52 (5.51 ATR) |
| **ZEC** | up (BOS 10 candles ago) | buy-side (bearish idea) 1 candles ago | bull 1,562.50-1,569.87 | bull 1,098.88-1,133.82 | above the range (175%) | swing high 1,679.83 (3.7 ATR) | swing low 1,533.12 (2.08 ATR) |
| **XRP** | down (CHOCH 30 candles ago) | sell-side (bullish idea) 10 candles ago | bull 1.5156-1.5195 (retraced) | bull 1.3773-1.3856 | premium (93%) | swing high 1.5612 (0.4 ATR) | swing low 1.4517 (5.3 ATR) |
| **LTC** | up (BOS 50 candles ago) | sell-side (bullish idea) 5 candles ago | bear 72.340-72.720 (retraced) | bull 58.800-63.080 | discount (36%) | swing high 72.290 (1.08 ATR) | swing low 65.520 (3.81 ATR) |
| **BNB** | up (CHOCH 3 candles ago) | sell-side (bullish idea) 30 candles ago | bear 781.33-782.43 (retraced) | bear 787.07-797.61 | premium (65%) | swing high 780.08 (0.73 ATR) | swing low 771.00 (1.37 ATR) |
...
| donchian_breakout | 1.0 | 1h | **FAILED** | 3117 | 48.2 | -0.061 | 0.88 | 225.5R | -0.08 / -0.03 | -0.07 / -0.05 | 0/5 ✗ | -0.11 | ✗  stop atr 2.0→1.6: -0.08R | 1 | 0.09R | 32, +0.22 (+0.13 / +0.30) | 128 / 109 of 426 | 0 | avg -0.06R/trade (needs +0.10R); profit factor 0.88; max drawdown 225.5R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7315 | 54.0 | -0.125 | 0.55 | 916.8R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 38, -0.17 (-0.28 / +0.01) | 1010 / 6 of 1365 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.55; max drawdown 916.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6580 | 47.1 | -0.146 | 0.75 | 977.2R | -0.14 / -0.15 | -0.19 / -0.10 | 0/5 ✗ | -0.22 | ✗  stop atr 1.5→1.2: -0.18R | 0 | 0.13R | 44, +0.09 (-0.20 / +0.41) | 1205 / 320 of 1896 | 0 | avg -0.15R/trade (needs +0.10R); profit factor 0.75; max drawdown 977.2R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 1h | **FAILED** | 868 | 32.3 | -0.176 | 0.78 | 182.4R | -0.13 / -0.26 | -0.22 / -0.14 | 1/5 ✗ | -0.28 | ✗  stop buffer_atr 0.2→0.16: -0.22R | 1 | 0.21R | 10, -0.18 (+0.20 / -0.57) | 485 / 1186 of 1751 | 0 | avg -0.18R/trade (needs +0.10R); profit factor 0.78; max drawdown 182.4R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 30m | **FAILED** | 3435 | 46.0 | -0.201 | 0.68 | 711.9R | -0.19 / -0.23 | -0.23 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.19R | 77, +0.17 (+0.18 / +0.15) | 813 / 251 of 1691 | 0 | avg -0.20R/trade (needs +0.10R); profit factor 0.68; max drawdown 711.9R; not profitable in BOTH train and unseen test |
...
| S6-OB-FVG-noSMC | 1.0 | 15m | **FAILED** | 37 | 35.1 | -0.212 | 0.69 | 11.1R | +0.05 / -0.59 | -0.46 / -0.00 | 1/5 ✗ | -0.32 | ✗  time_stop_bars 30→24: -0.26R | 2 | 0.16R | 6, -0.26 (+1.40 / -0.59) | 107 / 34 of 155 | 0 | avg -0.21R/trade (needs +0.10R); profit factor 0.69; max drawdown 11.1R; not profitable in BOTH train and unseen test |
...
| bb_squeeze_breakout | 1.0 | 30m | **FAILED** | 471 | 44.4 | -0.251 | 0.62 | 118.7R | -0.30 / -0.13 | -0.28 / -0.23 | 0/5 ✗ | -0.36 | ✗  stop atr 1.5→1.2: -0.33R | 0 | 0.20R | 15, -0.38 (-0.45 / -0.28) | 117 / 32 of 192 | 0 | avg -0.25R/trade (needs +0.10R); profit factor 0.62; max drawdown 118.7R; not profitable in BOTH train and unseen test |
| trend_pullback | 1.0 | 15m | **FAILED** | 2983 | 45.0 | -0.256 | 0.61 | 771.7R | -0.25 / -0.28 | -0.30 / -0.23 | 0/5 ✗ | -0.42 | ✗  stop atr 1.5→1.2: -0.34R | 0 | 0.27R | 162, -0.09 (-0.16 / -0.00) | 1353 / 351 of 2287 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.26R/trade (needs +0.10R); profit factor 0.61; max drawdown 771.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2143 | 32.7 | -0.356 | 0.19 | 763.4R | -0.35 / -0.38 | -0.44 / -0.28 | 0/5 ✗ | -0.53 | ✗  hi 90→108: -0.44R | 0 | 0.30R | 57, -0.27 (-0.29 / -0.17) | 1189 / 34 of 1365 | 0 | not cost-viable: fees + slippage 0.30R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.19; max drawdown 763.4R; not profitable in BOTH train and unseen test |
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 540 | 41.9 | -0.357 | 0.5 | 193.9R | -0.35 / -0.37 | -0.32 / -0.38 | 0/5 ✗ | -0.52 | ✗  stop atr 1.5→1.2: -0.43R | 0 | 0.31R | 36, -0.72 (-0.44 / -1.15) | 113 / 50 of 220 | 0 | not cost-viable: fees + slippage 0.31R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.50; max drawdown 193.9R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 616 | 25.5 | -0.442 | 0.55 | 280.8R | -0.46 / -0.40 | -0.58 / -0.34 | 0/5 ✗ | -0.61 | ✗  n 20→24: -0.47R | 1 | 0.35R | 18, +0.08 (-0.49 / +0.53) | 448 / 1087 of 1722 | 0 | not cost-viable: fees + slippage 0.35R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.55; max drawdown 280.8R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 30m | **FAILED** | 329 | 39.2 | -0.444 | 0.4 | 146.5R | -0.41 / -0.54 | -0.44 / -0.45 | 0/5 ✗ | -0.60 | ✗  stop atr 1.0→0.8: -0.48R | 0 | 0.29R | 13, -0.50 (-0.33 / -0.69) | 113 / 216 of 354 | 0 | not cost-viable: fees + slippage 0.29R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.40; max drawdown 146.5R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 15m | **FAILED** | 567 | 38.6 | -0.507 | 0.37 | 289.3R | -0.50 / -0.52 | -0.59 / -0.47 | 0/5 ✗ | -0.72 | ✗  stop atr 1.0→0.8: -0.55R | 0 | 0.39R | 27, -0.52 (-0.65 / -0.41) | 102 / 236 of 370 | 0 | not cost-viable: fees + slippage 0.39R per trade (stop must be ≥ 4x the round-trip cost); avg -0.51R/trade (needs +0.10R); profit factor 0.37; max drawdown 289.3R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 419 | 26.0 | -1.175 | 0.15 | 495.0R | -1.26 / -1.07 | -1.08 / -1.65 | 0/5 ✗ | -1.86 | ✗  stop atr 1.0→0.8: -1.53R | 0 | 1.08R | 114, -1.16 (-1.34 / -0.97) | 191 / 637 of 947 | 0 | not cost-viable: fees + slippage 1.08R per trade (stop must be ≥ 4x the round-trip cost); avg -1.17R/trade (needs +0.10R); profit factor 0.15; max drawdown 495.0R; not profitable in BOTH train and unseen test |
