...
**Updated:** 2026-09-25 09:17 Beijing time (2026-09-25 01:17 UTC) · data: Binance · 10 coins scanned
...
```
POSITION BOOK — 2026-09-25 01:17 UTC / 2026-09-25 09:17 Beijing
...
|---|---|---|
| PROVE | $165M | spread 0.129% > 0.1%; order book too thin: $57k within 1% (need $250k) |
| ONDO | $125M | 7-day average volume $43M < $50M; 24h move +30.3% is beyond ±25% - suspended for the rest of the UTC day; order book too thin: $133k within 1% (need $250k) |
...
|---|---|---|---|---|---|---|
| BTC | mixed (HH/LL) | 84,942.4 / 82,874.9 | 0.58 | 0.70x | 0.93x | bull_engulf, bull_reject |
| ETH | mixed (HH/LL) | 2,706 / 2,600.15 | 0.28 | 0.41x | 0.94x | bull_engulf, bull_reject, bear_reject |
| XRP | mixed (HH/LL) | 1.5435 / 1.4517 | 0.38 | 1.58x | 0.92x | - |
| SOL | mixed (HH/LL) | 117.79 / 112.52 | 0.61 | 0.68x | 0.90x | - |
| ZEC | mixed (HH/LL) | 1,574.6 / 1,456.92 | 0.11 | 0.57x | 0.98x | bull_engulf, bull_reject, bear_reject |
| LTC | mixed (LH/HL) | 72.42 / 65.52 | 0.18 | 0.28x | 1.70x | bull_engulf, bear_engulf, bull_reject |
| BNB | mixed (HH/LL) | 786.29 / 763.04 | 0.18 | 0.64x | 0.80x | bear_reject |
...
| 1h | displacement_up | 613 | 46% | 33% | 26% | 74% | 42% | 29% | beats chance | 0.27R |
| 1h | displacement_down | 435 | 37% | 23% | 14% | 81% | 39% | 25% | can't tell from chance | 0.18R |
| 1h | bull_engulf | 1719 | 40% | 29% | 22% | 75% | 43% | 29% | worse than chance | 0.32R |
| 1h | bear_engulf | 1884 | 39% | 25% | 17% | 80% | 38% | 25% | can't tell from chance | 0.19R |
| 1h | bull_reject | 1417 | 40% | 29% | 22% | 75% | 42% | 30% | can't tell from chance | 0.31R |
...
| 1h | smc_sweep_bear | 708 | 37% | 23% | 16% | 81% | 39% | 25% | can't tell from chance | 0.19R |
| 1h | smc_bos_up | 409 | 43% | 31% | 23% | 78% | 42% | 28% | can't tell from chance | 0.27R |
| 1h | smc_bos_down | 280 | 38% | 27% | 18% | 82% | 38% | 25% | can't tell from chance | 0.21R |
| 1h | smc_choch_up | 114 | 49% | 36% | 30% | 71% | 42% | 30% | can't tell from chance | 0.33R |
| 1h | smc_choch_down | 112 | 46% | 29% | 16% | 73% | 37% | 25% | can't tell from chance | 0.17R |
| 1h | smc_fvg_retrace_bull | 889 | 44% | 32% | 24% | 72% | 42% | 29% | can't tell from chance | 0.30R |
| 1h | smc_fvg_retrace_bear | 806 | 41% | 28% | 19% | 78% | 39% | 25% | can't tell from chance | 0.20R |
| 30m | displacement_up | 629 | 42% | 32% | 26% | 77% | 41% | 29% | can't tell from chance | 0.31R |
| 30m | displacement_down | 409 | 39% | 24% | 14% | 83% | 36% | 21% | can't tell from chance | 0.20R |
| 30m | bull_engulf | 1725 | 40% | 28% | 20% | 76% | 41% | 28% | can't tell from chance | 0.36R |
| 30m | bear_engulf | 1761 | 35% | 21% | 15% | 82% | 36% | 21% | can't tell from chance | 0.22R |
| 30m | bull_reject | 1345 | 44% | 29% | 21% | 74% | 41% | 29% | beats chance | 0.36R |
| 30m | bear_reject | 1403 | 37% | 23% | 15% | 81% | 37% | 22% | can't tell from chance | 0.21R |
| 30m | smc_sweep_bull | 625 | 39% | 26% | 16% | 76% | 40% | 28% | can't tell from chance | 0.37R |
| 30m | smc_sweep_bear | 630 | 41% | 26% | 17% | 83% | 36% | 22% | beats chance | 0.21R |
| 30m | smc_bos_up | 464 | 40% | 33% | 27% | 77% | 41% | 30% | can't tell from chance | 0.33R |
| 30m | smc_bos_down | 233 | 35% | 22% | 13% | 85% | 36% | 22% | can't tell from chance | 0.24R |
| 30m | smc_choch_up | 97 | 37% | 23% | 16% | 84% | 39% | 28% | can't tell from chance | 0.39R |
| 30m | smc_choch_down | 100 | 36% | 21% | 16% | 82% | 35% | 20% | can't tell from chance | 0.19R |
| 30m | smc_fvg_retrace_bull | 985 | 41% | 28% | 21% | 75% | 41% | 28% | can't tell from chance | 0.37R |
| 30m | smc_fvg_retrace_bear | 817 | 38% | 22% | 16% | 81% | 35% | 21% | can't tell from chance | 0.24R |
| 15m | displacement_up | 482 | 36% | 27% | 20% | 82% | 35% | 24% | can't tell from chance | 0.43R |
| 15m | displacement_down | 461 | 34% | 21% | 13% | 85% | 37% | 22% | can't tell from chance | 0.28R |
| 15m | bull_engulf | 1662 | 37% | 27% | 19% | 78% | 35% | 24% | beats chance | 0.51R |
| 15m | bear_engulf | 1608 | 36% | 24% | 15% | 79% | 36% | 22% | can't tell from chance | 0.30R |
| 15m | bull_reject | 1334 | 35% | 23% | 16% | 80% | 35% | 24% | can't tell from chance | 0.52R |
| 15m | bear_reject | 1470 | 36% | 22% | 14% | 81% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | smc_sweep_bull | 591 | 37% | 25% | 20% | 78% | 35% | 24% | can't tell from chance | 0.47R |
| 15m | smc_sweep_bear | 630 | 38% | 25% | 15% | 83% | 36% | 23% | can't tell from chance | 0.29R |
| 15m | smc_bos_up | 348 | 39% | 28% | 22% | 80% | 37% | 26% | can't tell from chance | 0.42R |
| 15m | smc_bos_down | 345 | 33% | 20% | 14% | 85% | 35% | 22% | can't tell from chance | 0.33R |
| 15m | smc_choch_up | 91 | 36% | 24% | 19% | 79% | 38% | 27% | can't tell from chance | 0.46R |
| 15m | smc_choch_down | 94 | 34% | 20% | 13% | 82% | 37% | 22% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 1024 | 33% | 23% | 16% | 80% | 35% | 25% | can't tell from chance | 0.49R |
| 15m | smc_fvg_retrace_bear | 974 | 36% | 25% | 17% | 80% | 36% | 22% | can't tell from chance | 0.31R |
| 5m | displacement_up | 1191 | 31% | 21% | 16% | 84% | 28% | 19% | beats chance | 0.80R |
| 5m | displacement_down | 1145 | 29% | 19% | 13% | 86% | 31% | 21% | can't tell from chance | 0.53R |
| 5m | bull_engulf | 4136 | 26% | 18% | 13% | 83% | 27% | 19% | can't tell from chance | 0.89R |
| 5m | bear_engulf | 4067 | 32% | 21% | 14% | 83% | 31% | 21% | can't tell from chance | 0.55R |
| 5m | bull_reject | 3479 | 27% | 18% | 13% | 81% | 27% | 19% | can't tell from chance | 0.91R |
| 5m | bear_reject | 3674 | 32% | 21% | 15% | 82% | 31% | 21% | can't tell from chance | 0.52R |
| 5m | smc_sweep_bull | 1232 | 31% | 22% | 15% | 79% | 28% | 20% | beats chance | 0.79R |
| 5m | smc_sweep_bear | 1287 | 35% | 24% | 17% | 81% | 32% | 21% | can't tell from chance | 0.45R |
| 5m | smc_bos_up | 814 | 29% | 20% | 16% | 85% | 27% | 19% | can't tell from chance | 0.83R |
| 5m | smc_bos_down | 892 | 29% | 20% | 12% | 86% | 31% | 21% | can't tell from chance | 0.57R |
| 5m | smc_choch_up | 213 | 36% | 24% | 16% | 86% | 26% | 18% | beats chance | 0.90R |
| 5m | smc_choch_down | 215 | 28% | 18% | 13% | 86% | 32% | 22% | can't tell from chance | 0.52R |
| 5m | smc_fvg_retrace_bull | 3238 | 28% | 19% | 13% | 82% | 27% | 19% | can't tell from chance | 0.90R |
| 5m | smc_fvg_retrace_bear | 2964 | 28% | 19% | 12% | 85% | 31% | 20% | worse than chance | 0.55R |
...
- **1H UNCLEAR (weak)** - for: candle size 0.93x normal, Bollinger width above 47% of the last 100 candles · against: close above EMA-fast above EMA-slow; EMA-fast flat (-0.1 ATR in 10 candles); swing structure mixed; ADX 22 = in between (20-25); ADX 22 is close to a threshold; signals are mixed and trend strength is in between
...
|---|---|---|---|---|---|---|---|
| **BTC** | down (BOS 11 candles ago) | buy-side (bearish idea) 0 candles ago | bull 84,445.92-84,549.55 (retraced) | bear 86,133.40-86,975.51 | premium (83%) | swing high 84,942.45 (0.67 ATR) | swing low 82,874.93 (3.28 ATR) |
| **ETH** | down (BOS 11 candles ago) | buy-side (bearish idea) 0 candles ago | bull 2,675.72-2,679.23 (retraced) | bear 2,745.99-2,784.40 | premium (86%) | equal highs 2,706.00 (0.71 ATR) | swing low 2,600.15 (4.21 ATR) |
| **XRP** | up (BOS 4 candles ago) | buy-side (bearish idea) 13 candles ago | bull 1.5364-1.5453 (retraced) | bull 1.3773-1.3856 | above the range (101%) | PDH 1.5481 (0.18 ATR) | swing low 1.4517 (4.44 ATR) |
| **SOL** | up (BOS 4 candles ago) | buy-side (bearish idea) 0 candles ago | bull 117.16-117.31 (retraced) | bear 117.85-119.66 | premium (93%) | swing high 117.79 (0.33 ATR) | swing low 112.52 (4.45 ATR) |
| **ZEC** | up (BOS 4 candles ago) | buy-side (bearish idea) 35 candles ago | bull 1,517.23-1,526.13 (retraced) | bull 1,098.88-1,133.82 | premium (75%) | swing high 1,574.60 (1.05 ATR) | swing low 1,456.92 (3.2 ATR) |
| **LTC** | up (BOS 14 candles ago) | sell-side (bullish idea) 11 candles ago | bear 72.340-72.720 (retraced) | bull 58.800-63.080 | premium (82%) | swing high 72.420 (0.73 ATR) | swing low 65.520 (3.37 ATR) |
| **BNB** | up (BOS 35 candles ago) | sell-side (bullish idea) 11 candles ago | bear 781.33-782.43 (retraced) | bear 787.07-797.61 | premium (61%) | swing high 786.29 (1.88 ATR) | equal lows 763.04 (2.98 ATR) |
...
| S8-PDH-PDL-SWEEP-5M | 1.0 | 30m | **BACKTESTING** | 1 | 0.0 | -1.712 | 0.0 | 1.7R | +0.00 / -1.71 | -1.71 / +0.00 | 0/5 ✗ | -2.00 | ✗  stop buffer_atr 0.2→0.16: -1.75R | 0 | 0.86R | 0, +0.00 (+0.00 / +0.00) | 32 / 99 of 142 | 0 | not cost-viable: fees + slippage 0.86R per trade (stop must be ≥ 4x the round-trip cost); only 1 trades; avg -1.71R/trade (needs +0.10R); profit factor 0.00; only 1 unseen-test trades; not profitable in BOTH train and unseen test |
...
| donchian_breakout | 1.0 | 1h | **FAILED** | 3117 | 48.2 | -0.061 | 0.88 | 225.5R | -0.08 / -0.03 | -0.07 / -0.05 | 0/5 ✗ | -0.11 | ✗  stop atr 2.0→1.6: -0.08R | 1 | 0.09R | 31, +0.26 (+0.13 / +0.39) | 128 / 111 of 428 | 0 | avg -0.06R/trade (needs +0.10R); profit factor 0.88; max drawdown 225.5R; not profitable in BOTH train and unseen test |
...
| donchian_breakout | 1.0 | 30m | **FAILED** | 1282 | 48.7 | -0.080 | 0.85 | 130.7R | -0.09 / -0.05 | -0.05 / -0.11 | 1/5 ✗ | -0.15 | ✗  stop atr 2.0→1.6: -0.15R | 2 | 0.13R | 43, -0.04 (-0.06 / -0.01) | 138 / 65 of 457 | 0 | avg -0.08R/trade (needs +0.10R); profit factor 0.85; max drawdown 130.7R; not profitable in BOTH train and unseen test |
...
| S8-PDH-PDL-SWEEP | 1.0 | 1h | **FAILED** | 325 | 33.5 | -0.118 | 0.85 | 55.7R | -0.09 / -0.19 | -0.35 / +0.10 | 1/5 ✗ | -0.22 | ✗  time_stop_bars 30→36: -0.14R | 2 | 0.20R | 0, +0.00 (+0.00 / +0.00) | 91 / 232 of 332 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.85; max drawdown 55.7R; not profitable in BOTH train and unseen test |
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 7315 | 54.0 | -0.125 | 0.55 | 916.8R | -0.10 / -0.17 | -0.14 / -0.11 | 0/5 ✗ | -0.19 | ✗  stop atr 2.0→1.6: -0.15R | 0 | 0.11R | 34, -0.20 (-0.28 / -0.01) | 1012 / 6 of 1366 | 0 | avg -0.12R/trade (needs +0.10R); profit factor 0.55; max drawdown 916.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6580 | 47.1 | -0.146 | 0.75 | 977.2R | -0.14 / -0.15 | -0.19 / -0.10 | 0/5 ✗ | -0.22 | ✗  stop atr 1.5→1.2: -0.18R | 0 | 0.13R | 45, +0.07 (-0.22 / +0.35) | 1200 / 317 of 1883 | 0 | avg -0.15R/trade (needs +0.10R); profit factor 0.75; max drawdown 977.2R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 1h | **FAILED** | 868 | 32.3 | -0.176 | 0.78 | 182.4R | -0.13 / -0.26 | -0.22 / -0.14 | 1/5 ✗ | -0.28 | ✗  stop buffer_atr 0.2→0.16: -0.22R | 1 | 0.21R | 10, -0.18 (-1.18 / +0.07) | 485 / 1183 of 1748 | 0 | avg -0.18R/trade (needs +0.10R); profit factor 0.78; max drawdown 182.4R; not profitable in BOTH train and unseen test |
...
| ema_9_21_cross | 1.0 | 15m | **FAILED** | 449 | 44.3 | -0.195 | 0.68 | 94.2R | -0.21 / -0.15 | -0.26 / -0.16 | 1/5 ✗ | -0.35 | ✗  stop atr 1.5→1.2: -0.30R | 1 | 0.27R | 21, +0.00 (+0.14 / -0.34) | 66 / 18 of 111 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.19R/trade (needs +0.10R); profit factor 0.68; max drawdown 94.2R; not profitable in BOTH train and unseen test |
| trend_pullback | 1.0 | 30m | **FAILED** | 3435 | 46.0 | -0.201 | 0.68 | 711.9R | -0.19 / -0.23 | -0.23 / -0.17 | 0/5 ✗ | -0.32 | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.19R | 76, +0.20 (+0.15 / +0.25) | 803 / 247 of 1662 | 0 | avg -0.20R/trade (needs +0.10R); profit factor 0.68; max drawdown 711.9R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 1h | **FAILED** | 329 | 47.4 | -0.221 | 0.64 | 73.6R | -0.23 / -0.21 | -0.24 / -0.19 | 0/5 ✗ | -0.32 | ✗  vol_x 1.2→1.44: -0.33R | 2 | 0.17R | 5, -0.41 (-1.11 / -0.23) | 108 / 220 of 336 | 0 | avg -0.22R/trade (needs +0.10R); profit factor 0.64; max drawdown 73.6R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 15m | **FAILED** | 2983 | 45.0 | -0.256 | 0.61 | 771.7R | -0.25 / -0.28 | -0.30 / -0.23 | 0/5 ✗ | -0.42 | ✗  stop atr 1.5→1.2: -0.34R | 0 | 0.27R | 157, -0.06 (-0.16 / +0.07) | 1342 / 343 of 2267 | 0 | not cost-viable: fees + slippage 0.27R per trade (stop must be ≥ 4x the round-trip cost); avg -0.26R/trade (needs +0.10R); profit factor 0.61; max drawdown 771.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 15m | **FAILED** | 2143 | 32.7 | -0.356 | 0.19 | 763.4R | -0.35 / -0.38 | -0.44 / -0.28 | 0/5 ✗ | -0.53 | ✗  hi 90→108: -0.44R | 0 | 0.30R | 57, -0.24 (-0.28 / -0.07) | 1193 / 35 of 1377 | 0 | not cost-viable: fees + slippage 0.30R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.19; max drawdown 763.4R; not profitable in BOTH train and unseen test |
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 540 | 41.9 | -0.357 | 0.5 | 193.9R | -0.35 / -0.37 | -0.32 / -0.38 | 0/5 ✗ | -0.52 | ✗  stop atr 1.5→1.2: -0.43R | 0 | 0.31R | 36, -0.72 (-0.44 / -1.06) | 112 / 46 of 217 | 0 | not cost-viable: fees + slippage 0.31R per trade (stop must be ≥ 4x the round-trip cost); avg -0.36R/trade (needs +0.10R); profit factor 0.50; max drawdown 193.9R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 616 | 25.5 | -0.442 | 0.55 | 280.8R | -0.46 / -0.40 | -0.58 / -0.34 | 0/5 ✗ | -0.61 | ✗  n 20→24: -0.47R | 1 | 0.35R | 18, +0.08 (-1.35 / +0.48) | 456 / 1073 of 1707 | 0 | not cost-viable: fees + slippage 0.35R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.55; max drawdown 280.8R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 30m | **FAILED** | 329 | 39.2 | -0.444 | 0.4 | 146.5R | -0.41 / -0.54 | -0.44 / -0.45 | 0/5 ✗ | -0.60 | ✗  stop atr 1.0→0.8: -0.48R | 0 | 0.29R | 13, -0.50 (-0.19 / -0.59) | 115 / 211 of 351 | 0 | not cost-viable: fees + slippage 0.29R per trade (stop must be ≥ 4x the round-trip cost); avg -0.44R/trade (needs +0.10R); profit factor 0.40; max drawdown 146.5R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 15m | **FAILED** | 567 | 38.6 | -0.507 | 0.37 | 289.3R | -0.50 / -0.52 | -0.59 / -0.47 | 0/5 ✗ | -0.72 | ✗  stop atr 1.0→0.8: -0.55R | 0 | 0.39R | 28, -0.46 (-0.52 / -0.43) | 102 / 235 of 370 | 0 | not cost-viable: fees + slippage 0.39R per trade (stop must be ≥ 4x the round-trip cost); avg -0.51R/trade (needs +0.10R); profit factor 0.37; max drawdown 289.3R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP | 1.0 | 30m | **FAILED** | 117 | 21.4 | -0.527 | 0.46 | 64.7R | -0.43 / -0.71 | -0.71 / -0.38 | 0/5 ✗ | -0.65 | ✗  stop max_width_atr 3.0→2.4: -0.53R | 0 | 0.26R | 4, +0.38 (-1.25 / +2.00) | 32 / 99 of 142 | 0 | not cost-viable: fees + slippage 0.26R per trade (stop must be ≥ 4x the round-trip cost); avg -0.53R/trade (needs +0.10R); profit factor 0.46; max drawdown 64.7R; not profitable in BOTH train and unseen test |
| ema_9_21_cross | 1.0 | 5m | **FAILED** | 256 | 29.3 | -0.745 | 0.25 | 192.4R | -0.88 / -0.56 | -0.66 / -1.10 | 0/5 ✗ | -1.13 | ✗  stop atr 1.5→1.2: -0.94R | 0 | 0.63R | 61, -0.57 (-0.53 / -0.65) | 203 / 78 of 349 | 0 | not cost-viable: fees + slippage 0.63R per trade (stop must be ≥ 4x the round-trip cost); avg -0.74R/trade (needs +0.10R); profit factor 0.25; max drawdown 192.4R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 419 | 26.0 | -1.175 | 0.15 | 495.0R | -1.26 / -1.07 | -1.08 / -1.65 | 0/5 ✗ | -1.86 | ✗  stop atr 1.0→0.8: -1.53R | 0 | 1.08R | 110, -1.14 (-1.07 / -1.19) | 189 / 627 of 935 | 0 | not cost-viable: fees + slippage 1.08R per trade (stop must be ≥ 4x the round-trip cost); avg -1.17R/trade (needs +0.10R); profit factor 0.15; max drawdown 495.0R; not profitable in BOTH train and unseen test |
