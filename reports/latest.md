...
**Updated:** 2026-09-27 04:17 Beijing time (2026-09-26 20:17 UTC) · data: Binance · 8 coins scanned

> Signals only - not financial advice. Paper-trade first. Never risk money you cannot afford to lose.

**Storage:** repository 5.9 MB (GitHub) · large files of this run 2.4 MB, published to branch `live-reports` (replaced every run, no history)

```
POSITION BOOK — 2026-09-26 20:17 UTC / 2026-09-27 04:17 Beijing
...
Checked 2026-09-26 20:16 UTC. History is saved every hour from now on (exchanges keep only ~30 days).

Every building block reads ONE series, the main source (OKX), in backtests and live; Binance is kept as a separate research series and never mixed in (their levels differ).

| Coin | State | Main source | Main history | Funding now | Long/short | Taker buy/sell | Problems |
|---|---|---|---|---|---|---|---|
| BTC | GOOD | okx | 750 h since 2026-08-26 | -0.0006% | 1.34 | 0.64 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=BTCUSDT&period=1h&limit=500 |
| ETH | GOOD | okx | 750 h since 2026-08-26 | +0.0018% | 1.37 | 1.10 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ETHUSDT&period=1h&limit=500 |
| SOL | GOOD | okx | 750 h since 2026-08-26 | +0.0066% | 1.43 | 0.81 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SOLUSDT&period=1h&limit=500 |
| XRP | GOOD | okx | 750 h since 2026-08-26 | +0.0100% | 2.44 | 1.04 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=XRPUSDT&period=1h&limit=500 |
| ZEC | GOOD | okx | 750 h since 2026-08-26 | +0.0022% | 0.52 | 1.12 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ZECUSDT&period=1h&limit=500 |
| SUI | GOOD | okx | 750 h since 2026-08-26 | +0.0087% | 1.90 | - | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=SUIUSDT&period=1h&limit=500 |
| ENA | GOOD | okx | 750 h since 2026-08-26 | +0.0050% | 1.01 | 1.28 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=ENAUSDT&period=1h&limit=500 |
| UNI | GOOD | okx | 750 h since 2026-08-26 | +0.0100% | 1.83 | 0.91 | binance: HTTPError: 451 Client Error:  for url: https://fapi.binance.com/futures/data/openInterestHist?symbol=UNIUSDT&period=1h&limit=500 |
...
|---|---|---|
| BABY | $51M | 7-day average volume $25M < $50M; order book too thin: $49k within 1% (need $250k) |
...
|---|---|---|---|---|---|---|
| BTC | up (HH/HL) | 84,337 / 83,856.2 | 0.56 | 1.03x | 0.44x | bear_engulf, bull_reject |
| ETH | mixed (LH/HL) | 2,696 / 2,682 | 0.55 | 0.50x | 0.45x | bull_reject |
| SOL | down (LH/LL) | 122.1 / 119.82 | 0.65 | 0.39x | 0.82x | bull_reject |
| XRP | mixed (LH/HL) | 1.5541 / 1.5371 | 0.49 | 0.92x | 0.58x | breakout_down, retest_down |
| ZEC | down (LH/LL) | 1,540.22 / 1,517.41 | 0.96 | 0.62x | 0.63x | bull_engulf, bear_reject, retest_up |
| SUI | mixed (LH/HL) | 1.1925 / 1.155 | 0.34 | 0.33x | 0.91x | bear_engulf |
| ENA | up (HH/HL) | 0.2857 / 0.2632 | 0.20 | 0.20x | 1.05x | bear_reject |
...
| 4h | bull_reject | 733 | 42% | 29% | 20% | 79% | 43% | 30% | can't tell from chance | 0.12R |
| 4h | bear_reject | 740 | 47% | 33% | 23% | 73% | 48% | 32% | can't tell from chance | 0.07R |
...
| 4h | smc_bos_down | 202 | 52% | 40% | 28% | 66% | 47% | 31% | can't tell from chance | 0.07R |
| 4h | smc_choch_up | 70 | 51% | 33% | 29% | 80% | 46% | 31% | can't tell from chance | 0.11R |
...
| 1h | displacement_up | 515 | 47% | 35% | 28% | 73% | 43% | 30% | can't tell from chance | 0.24R |
| 1h | displacement_down | 347 | 38% | 24% | 15% | 81% | 40% | 26% | can't tell from chance | 0.17R |
| 1h | bull_engulf | 1377 | 40% | 28% | 22% | 75% | 42% | 29% | can't tell from chance | 0.29R |
| 1h | bear_engulf | 1469 | 40% | 25% | 17% | 79% | 39% | 25% | can't tell from chance | 0.18R |
...
| 1h | smc_sweep_bull | 506 | 42% | 27% | 20% | 76% | 43% | 29% | can't tell from chance | 0.27R |
| 1h | smc_sweep_bear | 589 | 38% | 24% | 15% | 81% | 39% | 25% | can't tell from chance | 0.16R |
| 1h | smc_bos_up | 326 | 44% | 31% | 25% | 78% | 43% | 31% | can't tell from chance | 0.22R |
| 1h | smc_bos_down | 224 | 37% | 28% | 19% | 83% | 37% | 23% | can't tell from chance | 0.20R |
| 1h | smc_choch_up | 100 | 49% | 38% | 32% | 70% | 44% | 31% | can't tell from chance | 0.31R |
| 1h | smc_choch_down | 96 | 47% | 30% | 17% | 74% | 37% | 23% | can't tell from chance | 0.16R |
| 1h | smc_fvg_retrace_bull | 701 | 45% | 33% | 26% | 70% | 42% | 30% | can't tell from chance | 0.26R |
| 1h | smc_fvg_retrace_bear | 650 | 42% | 29% | 19% | 78% | 39% | 25% | can't tell from chance | 0.18R |
| 30m | displacement_up | 520 | 43% | 32% | 26% | 76% | 44% | 31% | can't tell from chance | 0.26R |
| 30m | displacement_down | 330 | 42% | 25% | 14% | 82% | 36% | 21% | can't tell from chance | 0.15R |
| 30m | bull_engulf | 1407 | 42% | 29% | 22% | 75% | 43% | 30% | can't tell from chance | 0.31R |
| 30m | bear_engulf | 1398 | 37% | 22% | 15% | 82% | 36% | 21% | can't tell from chance | 0.18R |
| 30m | bull_reject | 1051 | 47% | 31% | 24% | 72% | 42% | 30% | beats chance | 0.29R |
| 30m | bear_reject | 1144 | 37% | 23% | 15% | 82% | 37% | 21% | can't tell from chance | 0.18R |
| 30m | smc_sweep_bull | 504 | 41% | 29% | 18% | 75% | 43% | 31% | can't tell from chance | 0.30R |
| 30m | smc_sweep_bear | 520 | 43% | 28% | 18% | 81% | 36% | 21% | beats chance | 0.18R |
| 30m | smc_bos_up | 386 | 42% | 34% | 28% | 76% | 43% | 30% | can't tell from chance | 0.28R |
| 30m | smc_bos_down | 181 | 36% | 22% | 11% | 85% | 36% | 21% | can't tell from chance | 0.21R |
| 30m | smc_choch_up | 83 | 39% | 23% | 18% | 83% | 43% | 30% | can't tell from chance | 0.33R |
| 30m | smc_choch_down | 81 | 42% | 23% | 17% | 80% | 39% | 23% | can't tell from chance | 0.14R |
| 30m | smc_fvg_retrace_bull | 773 | 44% | 30% | 23% | 73% | 43% | 30% | can't tell from chance | 0.28R |
| 30m | smc_fvg_retrace_bear | 624 | 38% | 22% | 16% | 82% | 37% | 21% | can't tell from chance | 0.20R |
| 15m | displacement_up | 367 | 36% | 27% | 20% | 82% | 37% | 25% | can't tell from chance | 0.35R |
| 15m | displacement_down | 368 | 35% | 20% | 13% | 85% | 38% | 24% | can't tell from chance | 0.25R |
| 15m | bull_engulf | 1311 | 38% | 27% | 19% | 78% | 36% | 25% | can't tell from chance | 0.44R |
| 15m | bear_engulf | 1285 | 36% | 24% | 15% | 79% | 37% | 23% | can't tell from chance | 0.25R |
| 15m | bull_reject | 1054 | 35% | 23% | 15% | 80% | 36% | 25% | can't tell from chance | 0.44R |
| 15m | bear_reject | 1122 | 35% | 22% | 15% | 81% | 37% | 23% | can't tell from chance | 0.25R |
| 15m | smc_sweep_bull | 478 | 37% | 25% | 20% | 78% | 37% | 25% | can't tell from chance | 0.41R |
| 15m | smc_sweep_bear | 523 | 39% | 26% | 14% | 82% | 37% | 23% | can't tell from chance | 0.24R |
| 15m | smc_bos_up | 275 | 40% | 29% | 22% | 81% | 37% | 25% | can't tell from chance | 0.32R |
| 15m | smc_bos_down | 295 | 33% | 18% | 13% | 85% | 37% | 22% | can't tell from chance | 0.29R |
| 15m | smc_choch_up | 74 | 31% | 24% | 18% | 82% | 36% | 24% | can't tell from chance | 0.41R |
| 15m | smc_choch_down | 73 | 36% | 22% | 14% | 81% | 37% | 23% | can't tell from chance | 0.27R |
| 15m | smc_fvg_retrace_bull | 806 | 34% | 25% | 16% | 81% | 37% | 25% | can't tell from chance | 0.42R |
| 15m | smc_fvg_retrace_bear | 765 | 38% | 26% | 18% | 79% | 36% | 23% | can't tell from chance | 0.26R |
| 5m | displacement_up | 964 | 32% | 21% | 16% | 84% | 29% | 20% | can't tell from chance | 0.68R |
| 5m | displacement_down | 924 | 28% | 17% | 12% | 86% | 31% | 21% | worse than chance | 0.45R |
| 5m | bull_engulf | 3352 | 27% | 18% | 13% | 83% | 28% | 20% | worse than chance | 0.77R |
| 5m | bear_engulf | 3311 | 32% | 22% | 14% | 82% | 32% | 21% | can't tell from chance | 0.48R |
| 5m | bull_reject | 2765 | 27% | 18% | 13% | 82% | 28% | 19% | can't tell from chance | 0.81R |
| 5m | bear_reject | 2986 | 33% | 22% | 15% | 81% | 32% | 22% | can't tell from chance | 0.45R |
| 5m | smc_sweep_bull | 978 | 31% | 22% | 15% | 79% | 30% | 21% | can't tell from chance | 0.70R |
| 5m | smc_sweep_bear | 1030 | 35% | 25% | 17% | 81% | 34% | 23% | can't tell from chance | 0.39R |
| 5m | smc_bos_up | 625 | 30% | 22% | 18% | 84% | 28% | 19% | can't tell from chance | 0.66R |
| 5m | smc_bos_down | 727 | 29% | 19% | 12% | 87% | 32% | 21% | can't tell from chance | 0.51R |
| 5m | smc_choch_up | 177 | 36% | 27% | 18% | 85% | 28% | 19% | beats chance | 0.80R |
| 5m | smc_choch_down | 179 | 26% | 15% | 10% | 87% | 33% | 22% | worse than chance | 0.47R |
| 5m | smc_fvg_retrace_bull | 2566 | 30% | 21% | 15% | 81% | 28% | 19% | beats chance | 0.77R |
| 5m | smc_fvg_retrace_bear | 2309 | 29% | 19% | 12% | 83% | 32% | 21% | worse than chance | 0.47R |
...
- **1H COMPRESSION (moderate)** - for: EMAs not lined up; EMA-fast flat (-0.2 ATR in 10 candles); ADX 14 = weak trend / ranging; candle size 0.44x normal, Bollinger width above 0% of the last 100 candles · against: swing structure up (HH/HL)
...
|---|---|---|---|---|---|---|---|
| **BTC** | up (BOS 46 candles ago) | sell-side (bullish idea) 28 candles ago | bear 84,020.76-84,063.18 (retraced) | bear 86,133.40-86,975.51 | discount (33%) | swing high 84,336.96 (1.45 ATR) | equal lows 83,848.91 (0.76 ATR) |
| **ETH** | down (BOS 6 candles ago) | buy-side (bearish idea) 34 candles ago | bear 2,685.41-2,687.58 (retraced) | bear 2,745.99-2,784.40 | discount (19%) | swing high 2,696.00 (1.23 ATR) | swing low 2,682.00 (0.28 ATR) |
| **SOL** | up (BOS 19 candles ago) | sell-side (bullish idea) 0 candles ago | bull 120.04-120.28 (retraced) | bull 115.86-117.34 | premium (58%) | swing high 122.10 (1.03 ATR) | swing low 119.82 (1.41 ATR) |
| **XRP** | down (CHOCH 6 candles ago) | sell-side (bullish idea) 0 candles ago | bear 1.5241-1.5344 (retraced) | bull 1.3773-1.3856 | below the range (-83%) | swing high 1.5541 (2.34 ATR) | swing low 1.5191 (0.29 ATR) |
| **ZEC** | down (BOS 44 candles ago) | buy-side (bearish idea) 6 candles ago | bull 1,542.93-1,545.92 | bull 1,098.88-1,133.82 | above the range (229%) | swing high 1,625.00 (3.12 ATR) | swing low 1,517.41 (2.94 ATR) |
| **SUI** | up (BOS 17 candles ago) | sell-side (bullish idea) 0 candles ago | bear 1.1649-1.1717 (retraced) | bull 1.0050-1.0598 | discount (14%) | swing high 1.1925 (1.79 ATR) | swing low 1.1550 (0.28 ATR) |
| **ENA** | up (BOS 39 candles ago) | sell-side (bullish idea) 14 candles ago | bull 0.25770-0.25950 (retraced) | bull 0.16130-0.17050 | discount (40%) | swing high 0.28570 (2.22 ATR) | swing low 0.26320 (1.45 ATR) |
...
| R4-BBRSI 🧪 lab | 1.0 | 30m | **FORMALIZED** | - | - | - | - | - | - / - | - / - | - | - | - | - | - | - | 26, -0.22 (-0.48 / +0.48) | 509 / 12 of 591 | 0 | waiting for the first daily research run (Layers B/C) |
...
| donchian_breakout-VEXIT 🧪 lab | 1.0 | 30m | **FORMALIZED** | - | - | - | - | - | - / - | - / - | - | - | - | - | - | - | 42, +0.06 (+0.33 / -0.55) | 106 / 29 of 313 | 0 | waiting for the first daily research run (Layers B/C) |
...
| donchian_breakout | 1.0 | 30m | **FAILED** | 1329 | 48.5 | -0.067 | 0.88 | 114.7R | -0.08 / -0.04 | -0.03 / -0.11 | 1/5 ✗ | -0.14 | - | ✗  stop atr 2.0→1.6: -0.14R | 3 | 0.12R | 42, +0.01 (+0.13 / -0.25) | 106 / 29 of 313 | 0 | avg -0.07R/trade (needs +0.10R); profit factor 0.88; max drawdown 114.7R; not profitable in BOTH train and unseen test |
...
| rsi2_dip_buy | 1.0 | 1h | **FAILED** | 6989 | 53.6 | -0.129 | 0.54 | 906.7R | -0.11 / -0.17 | -0.14 / -0.12 | 0/5 ✗ | -0.19 | - | ✗  stop atr 2.0→1.6: -0.16R | 0 | 0.11R | 35, -0.15 (-0.31 / +0.09) | 830 / 1 of 1119 | 0 | avg -0.13R/trade (needs +0.10R); profit factor 0.54; max drawdown 906.7R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 1h | **FAILED** | 6338 | 47.2 | -0.138 | 0.76 | 900.0R | -0.14 / -0.13 | -0.18 / -0.10 | 0/5 ✗ | -0.21 | - | ✗  stop atr 1.5→1.2: -0.18R | 1 | 0.13R | 37, +0.04 (-0.09 / +0.25) | 917 / 217 of 1453 | 0 | avg -0.14R/trade (needs +0.10R); profit factor 0.76; max drawdown 900.0R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 30m | **FAILED** | 3534 | 46.3 | -0.190 | 0.69 | 692.8R | -0.18 / -0.22 | -0.22 / -0.16 | 0/5 ✗ | -0.30 | - | ✗  stop atr 1.5→1.2: -0.25R | 0 | 0.17R | 67, +0.23 (+0.54 / -0.24) | 665 / 166 of 1349 | 0 | avg -0.19R/trade (needs +0.10R); profit factor 0.69; max drawdown 692.8R; not profitable in BOTH train and unseen test |
| rsi2_dip_buy | 1.0 | 30m | **FAILED** | 2827 | 47.6 | -0.193 | 0.41 | 545.8R | -0.18 / -0.23 | -0.25 / -0.14 | 0/5 ✗ | -0.29 | - | ✗  hi 90→108: -0.25R | 0 | 0.16R | 35, -0.15 (-0.16 / -0.11) | 848 / 13 of 1020 | 0 | avg -0.19R/trade (needs +0.10R); profit factor 0.41; max drawdown 545.8R; not profitable in BOTH train and unseen test |
...
| trend_pullback | 1.0 | 15m | **FAILED** | 3140 | 45.1 | -0.251 | 0.62 | 793.3R | -0.24 / -0.28 | -0.29 / -0.23 | 0/5 ✗ | -0.40 | - | ✗  stop atr 1.5→1.2: -0.33R | 0 | 0.25R | 142, -0.05 (+0.08 / -0.30) | 1018 / 258 of 1804 | 0 | not cost-viable: fees + slippage 0.25R per trade (stop must be ≥ 4x the round-trip cost); avg -0.25R/trade (needs +0.10R); profit factor 0.62; max drawdown 793.3R; not profitable in BOTH train and unseen test |
...
| bb_squeeze_breakout | 1.0 | 15m | **FAILED** | 575 | 42.1 | -0.344 | 0.52 | 200.9R | -0.32 / -0.41 | -0.31 / -0.36 | 0/5 ✗ | -0.49 | - | ✗  stop atr 1.5→1.2: -0.42R | 0 | 0.29R | 37, -0.66 (-0.44 / -0.99) | 83 / 40 of 179 | 0 | not cost-viable: fees + slippage 0.29R per trade (stop must be ≥ 4x the round-trip cost); avg -0.34R/trade (needs +0.10R); profit factor 0.52; max drawdown 200.9R; not profitable in BOTH train and unseen test |
| S8-PDH-PDL-SWEEP-noSMC | 1.0 | 30m | **FAILED** | 605 | 26.0 | -0.424 | 0.56 | 265.0R | -0.41 / -0.45 | -0.55 / -0.32 | 1/5 ✗ | -0.60 | - | ✗  n 20→24: -0.49R | 2 | 0.32R | 15, +0.13 (+0.45 / -0.24) | 367 / 799 of 1328 | 0 | not cost-viable: fees + slippage 0.32R per trade (stop must be ≥ 4x the round-trip cost); avg -0.42R/trade (needs +0.10R); profit factor 0.56; max drawdown 265.0R; not profitable in BOTH train and unseen test |
...
| liquidity_sweep_reversal | 1.0 | 15m | **FAILED** | 582 | 39.5 | -0.466 | 0.4 | 272.9R | -0.44 / -0.55 | -0.61 / -0.40 | 0/5 ✗ | -0.67 | - | ✗  stop atr 1.0→0.8: -0.54R | 0 | 0.37R | 22, -0.47 (-0.73 / -0.25) | 75 / 191 of 291 | 0 | not cost-viable: fees + slippage 0.37R per trade (stop must be ≥ 4x the round-trip cost); avg -0.47R/trade (needs +0.10R); profit factor 0.40; max drawdown 272.9R; not profitable in BOTH train and unseen test |
...
| ema_9_21_cross | 1.0 | 5m | **FAILED** | 276 | 29.7 | -0.716 | 0.25 | 197.6R | -0.78 / -0.61 | -0.68 / -0.86 | 0/5 ✗ | -1.08 | - | ✗  stop atr 1.5→1.2: -0.90R | 0 | 0.55R | 53, -0.48 (-0.30 / -0.70) | 164 / 54 of 274 | 0 | not cost-viable: fees + slippage 0.55R per trade (stop must be ≥ 4x the round-trip cost); avg -0.72R/trade (needs +0.10R); profit factor 0.25; max drawdown 197.6R; not profitable in BOTH train and unseen test |
| liquidity_sweep_reversal | 1.0 | 5m | **FAILED** | 423 | 26.5 | -1.137 | 0.16 | 484.2R | -1.18 / -1.09 | -1.05 / -1.66 | 0/5 ✗ | -1.79 | - | ✗  stop atr 1.0→0.8: -1.47R | 0 | 1.02R | 97, -1.24 (-1.48 / -0.95) | 160 / 507 of 771 | 0 | not cost-viable: fees + slippage 1.02R per trade (stop must be ≥ 4x the round-trip cost); avg -1.14R/trade (needs +0.10R); profit factor 0.16; max drawdown 484.2R; not profitable in BOTH train and unseen test |
...
| `memory/smc_events.csv` | 113.9 KB | - | - |
