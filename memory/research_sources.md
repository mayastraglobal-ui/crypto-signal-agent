...
### [R4] freqtrade-strategies - community strategy ideas (ideas only, GPL-3.0)
- timestamp: 2026-09-25 18:45 UTC · source: https://github.com/freqtrade/freqtrade-strategies (commit f3340ce11f5bdf62f598522e64d1f5638eaa13f5, 2026-09-08) · evidence: UNVERIFIED_OPINION: community strategy files, published without evidence of an edge · confidence: low until tested here · strategy: - · asset: - · timeframe: - · regime: - · review: 2026-12-24
  - opened (Phase 18 C build session): the repository at the commit above - the entry / exit logic of BbandRsi, ClucMay72018, AdxSmas, ADXMomentum, AwesomeMacd, Simple, Quickie, MultiRSI, CCIStrategy, MACDStrategy_crossed, BinHV45, Low_BB, EMASkipPump (folder berlinguyinca), hlhb, Supertrend, Strategy001-005, SwingHighToSky, MultiMa (user_data/strategies) and VolatilitySystem, TrendFollowingStrategy (futures).
  - what we take: the 10 best-known ideas that our building blocks can express, rewritten as lab cards (queued in memory/experiments.md, `Queue: R4-...`): BbandRsi, ClucMay72018, hlhb, AwesomeMacd, VolatilitySystem, TrendFollowingStrategy, Supertrend, Strategy001, AdxSmas, Simple. Each card names its file (`source`, `source_url`) and how it differs from the file (`factory_evidence`): every card also trades the mirror-image short, uses our ATR stop and a first target of 2R instead of the file's ROI table, and the engine's regime gates.
