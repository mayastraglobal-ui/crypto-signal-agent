...
def main():
    ...
    watch = [p for p in final if p["stage"] != "APPROVED"][: cfg["signals"]["max_in_report"]]   # paper + validation
    ...
    if not args.offline:
        ...
        new_rows = []
        for p in final + watch:        # PAPER / VALIDATION signals are logged (the paper record) but never emailed
